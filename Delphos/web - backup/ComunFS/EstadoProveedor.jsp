...
<title>:: DELPHOS ::</title>
        ...
        <script type="text/javascript">
            ...
            var cajas = new Array('codestadoprov','descripcion','observacion');
            var combos = null;
			
			var arrayNonulos               	= new Array('codestadoprov');
			var arrayNumerosEnteros        	= null;
			var arrayCombos               	= null;			
			var arrayCadenasANCod          	= new Array('codestadoprov');
...
<tr>
    ...
    <td valign="top">
            ...
            <sql:query var="r" sql="SELECT * FROM estadoproveedor WHERE codestadoprov='${param.llave}'" dataSource="jdbc/delphos" scope="page"/>
            </c:if>
		...
		<form name="formulario" id="formulario" method="post" action="EstadoProveedor.jsp">
                  <span id="mensajeControlador">${msj}</span>
                  <tr>
                    <td colspan="6"><div align="center" class="titulo1">Estado Proveedor</div></td>
                  </tr>
                  <tr>
                    <td colspan="6">&nbsp;</td>
                  </tr>
                  <tr>
                    ...
                    <td width="132" class="bgDescTablas"><strong>C&oacute;digo Estado Proveedor</strong></td>
                    <td width="477" colspan="4" class="bgDescTablas"><label>
                      <input name="codestadoprov" type="text" id="codestadoprov" value="${codestadoprov}" size="20" maxlength="6" onkeypress="javascript:return permite(event, 'num_car_cod')" tabindex="1"/>
                    </label></td>
  </tr>
                  <tr>
...
<script>
    ...
    function validarPK()
    {
        llaves = 'codestadoprov='+document.getElementById('codestadoprov').value;
        //llaves+= 'codmunicipio='+document.getElementById('codmunicipio').value+',';
        validarLlave('estadoproveedor',llaves);
    } 
    ...
    function buscar()
    {
        ...
        url = url + "tabla=estadoproveedor&";
        url = url + "campos=codestadoprov,descripcion,observacion&";
        url = url + "campoLlave=codestadoprov";
