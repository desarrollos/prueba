...
<title>:: DELPHOS ::</title>
        ...
        <script type="text/javascript">
            ...
            var cajas = new Array('codestcumplimiento','descripcion');
            var combos = null;
                        
            //validar          
            var arrayNonulos               	= new Array ('codestcumplimiento');
            var arrayNumerosEnteros        	= null;
            var arrayCombos               	= null;
            var arrayCadenasANCod          	= new Array ('codestcumplimiento');
...
<tr>
    ...
    <td valign="top">
            ...
            <sql:query var="r" sql="SELECT * FROM estadocumplimiento WHERE codestcumplimiento='${param.llave}'" dataSource="jdbc/delphos" scope="page"/>
            </c:if>
		...
		<form name="formulario" id="formulario" method="post" action="EstadoCumplimiento.jsp">
                  <span id="mensajeControlador">${msj}</span>
                  <tr>
                    <td colspan="6"><div align="center" class="titulo1">Estado Cumplimiento</div></td>
                  </tr>
                  <tr>
                    <td colspan="6">&nbsp;</td>
                  </tr>
                  <tr>
                    ...
                    <td width="519" colspan="4" class="bgDescTablas"><label>
                      <input name="codestcumplimiento" type="text" id="codestcumplimiento" value="${codestcumplimiento}" size="20" maxlength="6" onkeypress="javascript:return permite(event, 'num_car_cod')" tabindex="1"/>
                    </label></td>
                  </tr>
                  <tr>
...
<script>
    ...
    function validarPK()
    {
        llaves = 'codestcumplimiento='+document.getElementById('codestcumplimiento').value;
        //llaves+= 'codmunicipio='+document.getElementById('codmunicipio').value+',';
        validarLlave('estadocumplimiento',llaves);
    } 
    ...
    function buscar()
    {
        ...
        url = url + "tabla=estadocumplimiento&";
        url = url + "campos=codestcumplimiento,descripcion&";
        url = url + "campoLlave=codestcumplimiento";
