...
<title>:: DELPHOS ::</title>
        ...
        <script type="text/javascript">
            ...
            var cajas = new Array('codfinalidadconsulta','descripcion','observacion');
            var combos = null;
                        
            //validar          
            var arrayNonulos               	= new Array ('codfinalidadconsulta');
            var arrayNumerosEnteros        	= null;
            var arrayCombos               	= null;
            var arrayCadenasANCod          	= new Array ('codfinalidadconsulta');
...
<tr>
    ...
    <td valign="top">
            ...
            <sql:query var="r" sql="SELECT * FROM finalidadconsulta WHERE codfinalidadconsulta='${param.llave}'" dataSource="jdbc/delphos" scope="page"/>
            </c:if>
		...
		<form name="formulario" id="formulario" method="post" action="FinalidadConsulta.jsp">
                  <span id="mensajeControlador">${msj}</span>
                  <tr>
                    <td colspan="3"><div align="center" class="titulo1">Finalidad Consulta</div></td>
                  </tr>
                  <tr>
                    <td colspan="3">&nbsp;</td>
                  </tr>
                  <tr>
                    ...
                    <td width="184" class="bgDescTablas"><strong>C&oacute;digo Finalidad Consulta</strong></td>
                    <td width="419" class="bgDescTablas"><input name="codfinalidadconsulta" type="text" id="codfinalidadconsulta" value="${codfinalidadconsulta}" size="20" maxlength="6" onkeypress="javascript:return permite(event, 'num_car_cod')" tabindex="1"/> </td>
                  </tr>
                  <tr>
...
<script>
    ...
    function validarPK()
    {
        llaves = 'codfinalidadconsulta='+document.getElementById('codfinalidadconsulta').value;
        //llaves+= 'codmunicipio='+document.getElementById('codmunicipio').value+',';
        validarLlave('finalidadconsulta',llaves);
    } 
    ...
    function buscar()
    {
        ...
        url = url + "tabla=finalidadconsulta&";
        url = url + "campos=codfinalidadconsulta,descripcion,observacion&";
        url = url + "campoLlave=codfinalidadconsulta";
