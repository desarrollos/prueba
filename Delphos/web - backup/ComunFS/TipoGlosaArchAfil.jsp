...
<title>:: DELPHOS ::</title>
        ...
        <script type="text/javascript">
            ...
            var cajas = new Array('codtipoglosaarchafil','descripcion','observacion');
            var combos = null;
            
            //validar
            var arrayNonulos               	= new Array ('codtipoglosaarchafil');
            var arrayNumerosEnteros        	= null;
            var arrayCombos               	= null;
            var arrayCadenasANCod          	= new Array ('codtipoglosaarchafil');
...
<tr>
    ...
    <td valign="top">
            ...
            <sql:query var="r" sql="SELECT * FROM tipoglosaarchafil WHERE codtipoglosaarchafil='${param.llave}'" dataSource="jdbc/delphos" scope="page"/>
            </c:if>
		...
		<form name="formulario" id="formulario" method="post" action="TipoGlosaArchAfil.jsp">
                  <span id="mensajeControlador">${msj}</span>
                  <tr>
                    <td colspan="6"><div align="center" class="titulo1">Tipo Glosa Archivo Afiliaci&oacute;n</div></td>
                  </tr>
                  <tr>
                    <td colspan="6">&nbsp;</td>
                  </tr>
                  <tr>
                    ...
                    <td width="124" class="bgDescTablas"><strong>C&oacute;digo Tipo Glosa</strong></td>
                    <td width="484" colspan="4" class="bgDescTablas"><label>
                      <input name="codtipoglosaarchafil" type="text" id="codtipoglosaarchafil" value="${codtipoglosaarchafil}" size="20" maxlength="6" onkeypress="javascript:return permite(event, 'num_car_cod')" tabindex="1"/>
                    </label>
                    </td>
                  </tr>
                  <tr>
...
<script>
    ...
    function validarPK()
    {
        ...
        validarLlave('tipoglosaarchafil',llaves);
    } 
    ...
    function buscar()
    {
        ...
        url = url + "tabla=tipoglosaarchafil&";
        url = url + "campos=codtipoglosaarchafil,descripcion,observacion&";
        url = url + "campoLlave=codtipoglosaarchafil";
