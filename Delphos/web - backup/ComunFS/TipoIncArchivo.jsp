...
<title>:: DELPHOS ::</title>
        ...
        <script type="text/javascript">
            ...
            var cajas = new Array('codtipoincarch','descripcion');
            var combos = null;
            
            //validar
            var arrayNonulos               	= new Array ('codtipoincarch');
            var arrayNumerosEnteros        	= null;
            var arrayCombos               	= null;
            var arrayCadenasANCod          	= new Array ('codtipoincarch');
...
<tr>
    ...
    <td valign="top">
            ...
            <sql:query var="r" sql="SELECT * FROM tipoincarchivo WHERE codtipoincarch='${param.llave}'" dataSource="jdbc/delphos" scope="page"/>
            </c:if>
		...
		<form name="formulario" id="formulario" method="post" action="TipoIncArchivo.jsp">
                  <span id="mensajeControlador">${msj}</span>
                  <tr>
                    <td colspan="3"><div align="center" class="titulo1">Tipo Inconsistencia</div></td>
                  </tr>
                  <tr>
                    <td colspan="3">&nbsp;</td>
                  </tr>
                  <tr>
                    ...
                    <label><strong>Tipo Inconsistencia</strong></label></td>
                    <td width="514" class="bgDescTablas">
                        <input name="codtipoincarch" type="text" id="codtipoincarch" value="${codtipoincarch}" size="20" maxlength="6" onkeypress="javascript:return permite(event, 'num_car_cod')" tabindex="1"/>                    </td>
                  </tr>
                  <tr>
...
<script>
    ...
    function validarPK()
    {
        llaves = 'codtipoincarch='+document.getElementById('codtipoincarch').value;
        //llaves+= 'codmunicipio='+document.getElementById('codmunicipio').value+',';
        validarLlave('tipoincarchivo',llaves);
    } 
    ...
    function buscar()
    {
        ...
        url = url + "tabla=tipoincarchivo&";
        url = url + "campos=codtipoincarch,descripcion&";
        url = url + "campoLlave=codtipoincarch";
