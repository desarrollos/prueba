...
<title>:: DELPHOS ::</title>
        ...
        <script type="text/javascript">
            ...
            var cajas = new Array('codfinalidadprocedimiento','descripcion','observacion');
            var combos = null;
			
            var arrayNonulos               	= new Array ('codfinalidadprocedimiento');
            var arrayNumerosEnteros        	= null;
            var arrayCombos               	= null;		
            var arrayCadenasANCod          	= new Array ('codfinalidadprocedimiento');
...
<tr>
    ...
    <td valign="top">
            ...
            <sql:query var="r" sql="SELECT * FROM finalidadprocedimiento WHERE codfinalidadprocedimiento='${param.llave}'" dataSource="jdbc/delphos" scope="page"/>
            </c:if>
		...
		<form name="formulario" id="formulario" method="post" action="FinalidadProcedimiento.jsp">
                  <span id="mensajeControlador">${msj}</span>
                  <tr>
                    <td colspan="3"><div align="center" class="titulo1">Finalidad Procedimiento</div></td>
                  </tr>
                  <tr>
                    <td colspan="3">&nbsp;</td>
                  </tr>
                  <tr>
                    ...
                    <td width="141" class="bgDescTablas"><strong>C&oacute;digo Finalidad Procedimiento</strong>                      </td>
                    <td width="468" class="bgDescTablas"><input name="codfinalidadprocedimiento" type="text" id="codfinalidadprocedimiento" value="${codfinalidadprocedimiento}" size="20" maxlength="6" onkeypress="javascript:return permite(event, 'num_car_cod')" tabindex="1"/> </td>
                  </tr>
                  <tr>
...
<script>
    ...
    function validarPK()
    {
        llaves = 'codfinalidadprocedimiento='+document.getElementById('codfinalidadprocedimiento').value;
        //llaves+= 'codmunicipio='+document.getElementById('codmunicipio').value+',';
        validarLlave('finalidadprocedimiento',llaves);
    } 
    ...
    function buscar()
    {
        ...
        url = url + "tabla=finalidadprocedimiento&";
        url = url + "campos=codfinalidadprocedimiento,descripcion,observacion&";
        url = url + "campoLlave=codfinalidadprocedimiento";
