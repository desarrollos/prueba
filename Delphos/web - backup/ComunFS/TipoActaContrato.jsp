...
<title>:: DELPHOS ::</title>
        ...
        <script type="text/javascript">
            ...
            var cajas = new Array('codtipoactacontrato','descripcion','observacion');
            var combos = null;
            
            //validar
            var arrayNonulos               	= new Array ('codtipoactacontrato');
            var arrayNumerosEnteros        	= null;
            var arrayCombos               	= null;
            var arrayCadenasANCod          	= new Array ('codtipoactacontrato');
...
<tr>
    ...
    <td valign="top">
            ...
            <sql:query var="r" sql="SELECT * FROM tipoactacontrato WHERE codtipoactacontrato='${param.llave}'" dataSource="jdbc/delphos" scope="page"/>
            </c:if>
		...
		<form name="formulario" id="formulario" method="post" action="TipoActaContrato.jsp">
                  <span id="mensajeControlador">${msj}</span>
                  <tr>
                    <td colspan="6"><div align="center" class="titulo1">Tipo Acta Contrato</div></td>
                  </tr>
                  <tr>
                    <td colspan="6">&nbsp;</td>
                  </tr>
                  <tr>
                    ...
                    <td width="127" class="bgDescTablas"><strong>C&oacute;digo Tipo Acta</strong></td>
                    <td width="519" colspan="4" class="bgDescTablas"><label>
                      <input name="codtipoactacontrato" type="text" id="codtipoactacontrato" value="${codtipoactacontrato}" size="20" maxlength="6" onkeypress="javascript:return permite(event, 'num_car_cod')" tabindex="1"/>
                    </label></td>
                  </tr>
                  <tr>
...
<script>
    ...
    function validarPK()
    {
        llaves = 'codtipoactacontrato='+document.getElementById('codtipoactacontrato').value;
        validarLlave('tipoactacontrato',llaves);
    } 
    ...
    function buscar()
    {
        ...
        url = url + "tabla=tipoactacontrato&";
        url = url + "campos=codtipoactacontrato,descripcion,observacion&";
        url = url + "campoLlave=codtipoactacontrato";
