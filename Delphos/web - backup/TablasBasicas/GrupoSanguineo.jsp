...
<title>:: DELPHOS ::</title>
        ...
        <script type="text/javascript">
            ...
            var cajas = new Array('codgruposanguineo','descripcion');
            var combos = null;
			
            var arrayNonulos               	= new Array ('codgruposanguineo');
            var arrayNumerosEnteros        	= null;
            var arrayCombos               	= null;		
            var arrayCadenasANCod          	= new Array ('codgruposanguineo');
...
<tr>
    ...
    <td valign="top">
            ...
            <sql:query var="r" sql="SELECT * FROM gruposanguineo WHERE codgruposanguineo='${param.llave}'" dataSource="jdbc/delphos" scope="page"/>
            </c:if>
		...
		<form name="formulario" id="formulario" method="post" action="GrupoSanguineo.jsp">
                  <span id="mensajeControlador">${msj}</span>
                  <tr>
                    <td colspan="6"><div align="center" class="titulo1">Grupo Sanguineo</div></td>
                  </tr>
                  <tr>
                    <td colspan="6">&nbsp;</td>
                  </tr>
                  <tr>
                    ...
                    <td width="139" class="bgDescTablas"><strong>C&oacute;digo Grupo Sanguineo</strong></td>
                    <td width="519" colspan="4" class="bgDescTablas"><label>
                      <input name="codgruposanguineo" type="text" id="codgruposanguineo" value="${codgruposanguineo}" size="20" maxlength="3" onkeypress="javascript:return permite(event, 'num_car_cod')" tabindex="1"/>
                    </label></td>
                  </tr>
                  <tr>
...
<script>
    ...
    function validarPK()
    {
        llaves = 'codgruposanguineo='+document.getElementById('codgruposanguineo').value;
        //llaves+= 'codmunicipio='+document.getElementById('codmunicipio').value+',';
        validarLlave('gruposanguineo',llaves);
    } 
    ...
    function buscar()
    {
        ...
        url = url + "tabla=gruposanguineo&";
        url = url + "campos=codgruposanguineo,descripcion&";
        url = url + "campoLlave=codgruposanguineo";
