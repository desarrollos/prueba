...
<title>:: DELPHOS ::</title>
        ...
        <script type="text/javascript">
            ...
            var cajas = new Array('codesquemaactividad','descripcion','observacion');
            var combos = null;
			
            var arrayNonulos               	= new Array('codesquemaactividad');
            var arrayNumerosEnteros        	= null;
            var arrayCombos               	= null;			
            var arrayCadenasANCod          	= new Array('codesquemaactividad');
...
<tr>
    ...
    <td valign="top">
            ...
            <sql:query var="r" sql="SELECT * FROM esquemaactividad WHERE codesquemaactividad='${param.llave}'" dataSource="jdbc/delphos" scope="page"/>
            </c:if>
		...
		<form name="formulario" id="formulario" method="post" action="EsquemaActividad.jsp">
                  <span id="mensajeControlador">${msj}</span>
                  <tr>
                    <td colspan="6"><div align="center" class="titulo1">Esquema Actividad</div></td>
                  </tr>
                  <tr>
                    <td colspan="6">&nbsp;</td>
                  </tr>
                  <tr>
                    ...
                    <td width="125" class="bgDescTablas"><strong>C&oacute;digo Esquema Actividad</strong></td>
                    <td width="484" colspan="4" class="bgDescTablas"><label>
                      <input name="codesquemaactividad" type="text" id="codesquemaactividad" value="${codesquemaactividad}" size="20" maxlength="6" onkeypress="javascript:return permite(event, 'num_car_cod')" tabindex="1"/>
                    </label></td>
                  </tr>
                  <tr>
...
<script>
    ...
    function validarPK()
    {
        llaves = 'codesquemaactividad='+document.getElementById('codesquemaactividad').value;
        //llaves+= 'codmunicipio='+document.getElementById('codmunicipio').value+',';
        validarLlave('esquemaactividad',llaves);
    } 
    ...
    function buscar()
    {
        ...
        url = url + "tabla=esquemaactividad&";
        url = url + "campos=codesquemaactividad,descripcion,observacion&";
        url = url + "campoLlave=codesquemaactividad";
