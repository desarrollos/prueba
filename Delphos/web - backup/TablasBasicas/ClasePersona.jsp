...
<title>:: DELPHOS ::</title>
        ...
        <script type="text/javascript">
            ...
            var cajas = new Array('codclasepersona','descripcion');
            var combos = null;
            
            //validar
            var arrayNonulos               	= new Array('codclasepersona');
            var arrayNumerosEnteros        	= null;
            var arrayCombos               	= null;
            var arrayCadenasANCod          	= new Array('codclasepersona');
...
<tr>
    ...
    <td valign="top">
        ...
        <center>
            ...
            <sql:query var="r" sql="SELECT * FROM clasepersona WHERE codclasepersona='${param.llave}'" dataSource="jdbc/delphos" scope="page"/>
            </c:if>
          ...
          <table width="795" border="0" class="tablaContenido">
            <form name="formulario" id="formulario" method="post" action="ClasePersona.jsp">
              <span id="mensajeControlador">${msj}</span>
              <tr>
                <td colspan="3"><div align="center" class="titulo1">Clase Persona</div></td>
              </tr>
              <tr>
                <td colspan="3">&nbsp;</td>
              </tr>
              <tr>
                ...
                <td width="123" class="bgDescTablas"><strong>C&oacute;digo Clase Persona</strong>
                  <label></label></td>
                <td width="535" class="bgDescTablas"><input name="codclasepersona" type="text" id="codclasepersona" value="${codclasepersona}" size="20" maxlength="1" onKeyPress="javascript:return permite(event, 'num_car_cod')" tabindex="1">
                <label></label></td>
              </tr>
              <tr>
                <td colspan="3">&nbsp;</td>
...
<script>
    ...
    function validarPK()
    {
        llaves = 'codclasepersona='+document.getElementById('codclasepersona').value;
        //llaves+= 'codmunicipio='+document.getElementById('codmunicipio').value+',';
        validarLlave('clasepersona',llaves);
    } 
    ...
    function buscar()
    {
        ...
        url = url + "tabla=clasepersona&";
        url = url + "campos=codclasepersona,descripcion&";
        url = url + "campoLlave=codclasepersona";
