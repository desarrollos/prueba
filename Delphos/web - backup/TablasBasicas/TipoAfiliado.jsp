...
<title>:: DELPHOS ::</title>
        ...
        <script type="text/javascript">
            ...
            var cajas =new Array('codtipoafiliado','codalterno','descripcion');
            var combos = null;
            
            //validar
            var arrayNonulos               	= new Array ('codtipoafiliado');
            var arrayNumerosEnteros        	= null;
            var arrayCombos               	= null;
            var arrayCadenasANCod          	= new Array ('codtipoafiliado','codalterno');
...
<tr>
    ...
    <td valign="top">
            ...
            <sql:query var="r" sql="SELECT * FROM tipoafiliado WHERE codtipoafiliado='${param.llave}'" dataSource="jdbc/delphos" scope="page"/>
            </c:if>
            <jsp2:forEach items="${r.rows}" var="fila" varStatus="contador">
              <c:set var="codtipoafiliado" value="${fila.codtipoafiliado}"/>
		...
		<form name="formulario" id="formulario" method="post" action="TipoAfiliado.jsp">
                  <span id="mensajeControlador">${msj}</span>
                  <tr>
                    <td colspan="6"><div align="center" class="titulo1">Tipo Afiliado</div></td>
                  </tr>
                  <tr>
                    <td colspan="6">&nbsp;</td>
                  </tr>
                  <tr>
                    ...
                    <td width="120" class="bgDescTablas"><strong>C&oacute;digo </strong>
                      <label><strong>Tipo Afiliado</strong></label></td>
                    <td width="181" class="bgDescTablas">
                        <input name="codtipoafiliado" type="text" id="codtipoafiliado" value="${codtipoafiliado}" size="20" maxlength="10" onkeypress="javascript:return permite(event, 'num_car_cod')" tabindex="1"/>                    </td>
...
<script>
    ...
    function validarPK()
    {
        llaves = 'codtipoafiliado='+document.getElementById('codtipoafiliado').value;
        validarLlave('tipoafiliado',llaves);
    } 
    ...
    function buscar()
    {
        ...
        url = url + "tabla=tipoafiliado&";
        url = url + "campos=codtipoafiliado,codalterno,descripcion&";
        url = url + "campoLlave=codtipoafiliado";
