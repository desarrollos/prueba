...
<title>:: DELPHOS ::</title>
        ...
        <script type="text/javascript">
            ...
            var cajas = new Array('codcapacpagousua','descripcion','observacion');
            var combos = null;
            
            //validar
            var arrayNonulos               	= new Array ('codcapacpagousua');
            var arrayNumerosEnteros        	= null;
            var arrayCombos               	= null;
            var arrayCadenasANCod          	= new Array ('codcapacpagousua');
...
<tr>
    ...
    <td valign="top">
            ...
            <sql:query var="r" sql="SELECT * FROM capacidadpagousua WHERE codcapacpagousua='${param.llave}'" dataSource="jdbc/delphos" scope="page"/>
            </c:if>
            <jsp2:forEach items="${r.rows}" var="fila" varStatus="contador">
              <c:set var="codcapacpagousua" value="${fila.codcapacpagousua}"/>
              <c:set var="descripcion" value="${fila.descripcion}"/> 
              <c:set var="observacion" value="${fila.observacion}"/>         
            </jsp2:forEach>
                
                <table width="792" border="0" class="tablaContenido">
		<form name="formulario" id="formulario" method="post" action="CapacidadPagoUsua.jsp">
                  <span id="mensajeControlador">${msj}</span>
                  <tr>
                    <td colspan="3"><div align="center" class="titulo1">Capacidad de Pago Usuario</div></td>
                  </tr>
                  <tr>
                    <td colspan="3">&nbsp;</td>
                  </tr>
                  <tr>
                    ...
                    <td width="121" class="bgDescTablas"><strong>C&oacute;digo Capacidad Pago</strong></td>
                    <td width="488" class="bgDescTablas">
                        <input name="codcapacpagousua" type="text" id="codcapacpagousua" value="${codcapacpagousua}" size="20" maxlength="6" onkeypress="javascript:return permite(event, 'num_car_cod')" tabindex="1"/>                    </td>
                  </tr>
                  <tr>
...
<script>
    ...
    function validarPK()
    {
        llaves = 'codcapacpagousua='+document.getElementById('codcapacpagousua').value;
        //llaves+= 'codmunicipio='+document.getElementById('codmunicipio').value+',';
        validarLlave('capacidadpagousua',llaves);
    } 
    ...
    function buscar()
    {
        ...
        url = url + "tabla=capacidadpagousua&";
        url = url + "campos=codcapacpagousua,descripcion,observacion&";
        url = url + "campoLlave=codcapacpagousua";
