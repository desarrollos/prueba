...
<title>:: DELPHOS ::</title>
        ...
        <script type="text/javascript">
            ...
            var cajas = new Array('codtipovinculacpersonal','descripcion','observacion');
            var combos = null;
            
            //validar
            var arrayNonulos               	= new Array ('codtipovinculacpersonal');
            var arrayNumerosEnteros        	= null;
            var arrayCombos               	= null;
            var arrayCadenasANCod          	= new Array ('codtipovinculacpersonal');
...
<tr>
    ...
    <td valign="top">
            ...
            <sql:query var="r" sql="SELECT * FROM tipovinculacpersonal WHERE codtipovinculacpersonal='${param.llave}'" dataSource="jdbc/delphos" scope="page"/>
            </c:if>
            <jsp2:forEach items="${r.rows}" var="fila" varStatus="contador">
              <c:set var="codtipovinculacpersonal" value="${fila.codtipovinculacpersonal}"/>
              <c:set var="descripcion" value="${fila.descripcion}"/>
              <c:set var="observacion" value="${fila.observacion}"/>          
            </jsp2:forEach>
                
                <table width="642" border="0" class="tablaContenido">
		<form name="formulario" id="formulario" method="post" action="TipoVinculacPersonal.jsp">
                  <span id="mensajeControlador">${msj}</span>
                  <tr>
                    <td colspan="6"><div align="center" class="titulo1">Tipo Vinculaci&oacute;n Personal</div></td>
                  </tr>
                  <tr>
                    <td colspan="6">&nbsp;</td>
                  </tr>
                  <tr>
                    ...
                    <td width="127" class="bgDescTablas"><strong>C&oacute;digo Tipo Vinculaci&oacute;n</strong></td>
                    <td width="519" colspan="4" class="bgDescTablas"><label>
                      <input name="codtipovinculacpersonal" type="text" id="codtipovinculacpersonal" value="${codtipovinculacpersonal}" size="20" maxlength="6" onkeypress="javascript:return permite(event, 'num_car_cod')" tabindex="1"/>
                    </label>
                    </td>
                  </tr>
                  <tr>
...
<script>
    ...
    function validarPK()
    {
        llaves = 'codtipovinculacpersonal='+document.getElementById('codtipovinculacpersonal').value;
        //llaves+= 'codmunicipio='+document.getElementById('codmunicipio').value+',';
        validarLlave('tipovinculacpersonal',llaves);
    } 
    ...
    function buscar()
    {
        ...
        url = url + "tabla=tipovinculacpersonal&";
        url = url + "campos=codtipovinculacpersonal,descripcion,observacion&";
        url = url + "campoLlave=codtipovinculacpersonal";
