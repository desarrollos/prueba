...
<title>:: DELPHOS ::</title>
        ...
        <script type="text/javascript">
            ...
            var cajas = new Array('codclaseglosaafil','descripcion','observacion');
            var combos = null;
            
            //validar
            var arrayNonulos               	= new Array ('codclaseglosaafil');
            var arrayNumerosEnteros        	= null;
            var arrayCombos               	= null;
            var arrayCadenasANCod          	= new Array ('codclaseglosaafil');
...
<tr>
    ...
    <td valign="top">
            ...
            <sql:query var="r" sql="SELECT * FROM claseglosaafil WHERE codclaseglosaafil='${param.llave}'" dataSource="jdbc/delphos" scope="page"/>
            </c:if>
		...
		<form name="formulario" id="formulario" method="post" action="ClaseGlosaAfil.jsp">
                  <span id="mensajeControlador">${msj}</span>
                  <tr>
                    <td colspan="6"><div align="center" class="titulo1">Clase Glosa</div></td>
                  </tr>
                  <tr>
                    <td colspan="6">&nbsp;</td>
                  </tr>
                  <tr>
                    ...
                    <td width="127" class="bgDescTablas"><strong>C&oacute;digo Clase Glosa</strong></td>
                    <td width="519" colspan="4" class="bgDescTablas"><label>
                      <input name="codclaseglosaafil" type="text" id="codclaseglosaafil" value="${codclaseglosaafil}" size="20" maxlength="6" onkeypress="javascript:return permite(event, 'num_car_cod')" tabindex="1"/>
                    </label></td>
                  </tr>
                  <tr>
...
<script>
    ...
    function validarPK()
    {
        ...
        validarLlave('claseglosaafil',llaves);
    } 
    ...
    function buscar()
    {
        ...
        url = url + "tabla=claseglosaafil&";
        url = url + "campos=codclaseglosaafil,descripcion,observacion&";
        url = url + "campoLlave=codclaseglosaafil";
