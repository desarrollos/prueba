                ...
                <ul>
                    <li><span class="folder">Inscripci&oacute;n</span>
                        <ul>
                            ...
                            <span class="file">     <li>
                                    <a href="<%= formularios%>Vinculacion.jsp?#tabs-1">Registro</a>
                                </li></span>
                            <span class="file">      <li>
                                    <a href="<%= formularios%>Vinculacion.jsp?#tabs-2">Documentos</a>
                                </li></span>
                            <span class="file">      <li>
                                    <a href="<%= formularios%>Vinculacion.jsp?#tabs-3">Grupos Titulares</a>
                                </li></span>
                            <span class="file">      <li>
                                    <a href="<%= formularios%>Vinculacion.jsp?#tabs-4">Titular Familia</a>
                                </li></span>
                            <span class="file">      <li>
                                    <a href="<%= formularios%>Vinculacion.jsp?#tabs-5">Beneficiarios</a>
                                </li></span>
                        </ul>
                    </li>
