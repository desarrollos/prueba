    ...
    // Comprobar si la tecla pulsada es alguna de las teclas especiales
      ...
      switch(permitidos) {
        ...
        case 'num_car_cod':
          ...
          break;
    //caracteres y numeros solamente con espacios en blanco, como para colocar en los codigos o llaves de cada formulario, siempre y cuando sea de tipo character varying en la bd
        case 'num_car':
          permitidos = caracteres+" "+numeros+""+tildes;
