...
<tr>
    ...
    <td valign="top">
        ...
        <center>
            ...
            <sql:query var="r" sql="SELECT * FROM archivocontroleapb WHERE idencabezado=${param.idencabezado} AND idregistro=${param.idregistro}" dataSource="jdbc/delphos" scope="page"/>
            </c:if>
            <jsp2:forEach items="${r.rows}" var="fila" varStatus="contador">
              ...
              <c:set var="codestregrips" value="${fila.codestregrips}"/>                            
				...
				<form action="ArchivoControlEAPB.jsp" method="post" name="formulario">
                  <tr>
                    <td colspan="6"><div align="center" class="titulo1">Archivo  Control EAPB </div></td>
                  </tr>
                  <tr>
                    <td colspan="6">&nbsp;</td>
                  </tr>
...
<script>    
    ...
    function validarPK()
    {
        ...
        validarLlave('archivocontroleapb',llaves);
    } 
    ...
    function buscar()
    {
        ...
        url = url + "tabla=archivocontroleapb&";
