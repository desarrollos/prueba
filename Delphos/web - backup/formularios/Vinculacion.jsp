    ...
    <body>
        ...
        <div id="dialog" class="c1">
            ...
            <form id="Vinculacion" name="Vinculacion">
                ...
                <div id="tabs">
                    <ul>
                        <li><a href="#tabs-1" id="inscripcion" name="Vinculacion">Vinculacion</a></li>
                        <li><a href="#tabs-2" id="documentoinscripcion" name="Documentos">Documentos</a></li>
                        <li><a href="#tabs-3" id="grupotitular" name="Grupos_Titulares">Grupos Titulares</a></li>
                        <li><a href="#tabs-4" id="titularfamilia" name="Titular_Familia">Titular Familia</a></li>
                        <li><a href="#tabs-5" id="beneficiario" name="Beneficiarios">Beneficiarios</a></li>
                    </ul>
                    <div id="tabs-1">
                        <div class="boton">
                    ...
                    <div id="tabs-5">
                        ...
                        <table>
                            ...
                            <tr>
                                <td> <select  id="codunifami_beneficiario" name="codunifami_beneficiario" onfocus="tabla(flexiVinculacion, 'Código Unico Familia', 'codunifami_beneficiario' )" onclick="tabla(flexiVinculacion, 'Código Unico Familia', 'codunifami_beneficiario' )"></select></td>
                            ...
                            <tr>
                                ...
                                <td> <select  id="empresa_beneficiario_2" name="empresa_beneficiario_2" onfocus="tabla(flexiEmpresas, 'Empresa', 'empresa_beneficiario_2' )" onclick="tabla(flexiEmpresas, 'Empresa', 'empresa_beneficiario_2' )"></select></td>
