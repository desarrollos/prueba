...
<script type="text/javascript">
            ...
            var combos = new Array('coddiagnosticos','codtareas');
            
            //validar
            var arrayNonulos               	= null;
            var arrayNumerosEnteros        	= null;
            var arrayCombos               	= new Array('coddiagnosticos','codtareas');
...
<tr>
    ...
    <td valign="top">
                <center>
            <c:if test="${param.coddiagnostico != null && param.codtarea != null}">
            <sql:query var="r" sql="SELECT * FROM tareadiagnostico WHERE coddiagnostico='${param.coddiagnostico}' AND codtarea='${param.codtarea}'" dataSource="jdbc/delphos" scope="page"/>
            </c:if>
		...
		<form action="TareaDiagnostico.jsp" method="post" name="formulario" id="formulario">
                  <span id="mensajeControlador">${msj}</span>
                  <tr>
                    <td colspan="6"><div align="center" class="titulo1">Tarea Diagn&oacute;stico </div></td>
                  </tr>
                  <tr>
                    <td colspan="6">&nbsp;</td>
                  </tr>
                  <tr>
                    ...
                    <td width="104" class="bgDescTablas"><strong>Diagn&oacute;stico</strong>
                    <label></label></td>
                    ...
                    <td width="85" class="bgDescTablas"><strong>Tarea</strong></td>
                    <td width="251" class="bgDescTablas">
					<select name="codtareas" id="codtareas" style="width: 150px" tabindex="2">
...
<script>
    ...
    function validarPK()
    {
        ...
        validarLlave('tareadiagnostico',llaves);
    } 
    ...
    function buscar()
    {
        ...
        url = url + "tabla=tareadiagnostico&";
        url = url + "campos=coddiagnostico,codtarea,observacion&";
        url = url + "campoLlave=coddiagnostico,codtarea";
