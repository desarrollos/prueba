...
<title>:: DELPHOS ::</title>
        ...
        <script type="text/javascript">
            ...
            var cajas = new Array('codtipohabitacion','descripcion','observacion');
            var combos = null;
            
            //validar
            var arrayNonulos               	= new Array ('codtipohabitacion');
            var arrayNumerosEnteros        	= null;
            var arrayCombos               	= null;
            var arrayCadenasANCod          	= new Array ('codtipohabitacion');
...
<tr>
    ...
    <td valign="top">
            ...
            <sql:query var="r" sql="SELECT * FROM tipohabitacion WHERE codtipohabitacion='${param.llave}'" dataSource="jdbc/delphos" scope="page"/>
            </c:if>
		...
		<form name="formulario" id="formulario" method="post" action="TipoHabitacion.jsp">
                  <span id="mensajeControlador">${msj}</span>
                  <tr>
                    <td colspan="6"><div align="center" class="titulo1">Tipo Habitaci&oacute;n</div></td>
                  </tr>
                  <tr>
                    <td colspan="6">&nbsp;</td>
                  </tr>
                  <tr>
                    ...
                    <td width="102" class="bgDescTablas"><strong>C&oacute;digo Tipo Habitaci&oacute;n</strong></td>
                    <td width="503" colspan="4" class="bgDescTablas"><label>
                      <input name="codtipohabitacion" type="text" id="codtipohabitacion" value="${codtipohabitacion}" size="20" maxlength="6" onkeypress="javascript:return permite(event, 'num_car_cod')" tabindex="1"/>
                    </label></td>
                  </tr>
                  <tr>
...
<script>
    ...
    function validarPK()
    {
        llaves = 'codtipohabitacion='+document.getElementById('codtipohabitacion').value;
        //llaves+= 'codmunicipio='+document.getElementById('codmunicipio').value+',';
        validarLlave('tipohabitacion',llaves);
    } 
    ...
    function buscar()
    {
        ...
        url = url + "tabla=tipohabitacion&";
        url = url + "campos=codtipohabitacion,descripcion,observacion&";
        url = url + "campoLlave=codtipohabitacion";
