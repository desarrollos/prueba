...
<title>:: DELPHOS ::</title>
        ...
        <script type="text/javascript">
            ...
            var cajas = new Array('codgrupopoblacion','descripcion');
            var combos = null;
                        
            //validar          
            var arrayNonulos               	= new Array ('codgrupopoblacion');
            var arrayNumerosEnteros        	= new Array ('codgrupopoblacion');
...
<tr>
    ...
    <td valign="top">
            ...
            <sql:query var="r" sql="SELECT * FROM grupopoblacion WHERE codgrupopoblacion=${param.llave}" dataSource="jdbc/delphos" scope="page"/>
            </c:if>
		...
		<form name="formulario" id="formulario" method="post" action="GrupoPoblacion.jsp">
                  <span id="mensajeControlador">${msj}</span>
                  <tr>
                    <td colspan="6"><div align="center" class="titulo1">Grupo Poblacional</div></td>
                  </tr>
                  <tr>
                    <td colspan="6">&nbsp;</td>
                  </tr>
                  <tr>
                    ...
                    <td width="127" class="bgDescTablas"><strong>C&oacute;digo Grupo Poblacional</strong></td>
                    <td width="519" colspan="4" class="bgDescTablas"><label>
                      <input name="codgrupopoblacion" type="text" id="codgrupopoblacion" value="${codgrupopoblacion}" size="20" maxlength="4" onkeypress="javascript:return permite(event, 'nume')" tabindex="1"/>
                    </label></td>
                  </tr>
                  <tr>
...
<script>
    ...
    function validarPK()
    {
        llaves = 'codgrupopoblacion='+document.getElementById('codgrupopoblacion').value;
        //llaves+= 'codmunicipio='+document.getElementById('codmunicipio').value+',';
        validarLlave('grupopoblacion',llaves);
    } 
    ...
    function buscar()
    {
        ...
        url = url + "tabla=grupopoblacion&";
        url = url + "campos=codgrupopoblacion,descripcion&";
        url = url + "campoLlave=codgrupopoblacion";
