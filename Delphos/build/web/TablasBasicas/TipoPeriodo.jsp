...
<title>:: DELPHOS ::</title>
        ...
        <script type="text/javascript">
            ...
            var cajas = new Array('codtipoperiodo','descripcion');
            var combos = null;
            
            //validar
            var arrayNonulos               	= new Array('codtipoperiodo');
            var arrayNumerosEnteros        	= null;
            var arrayCombos               	= null;
            var arrayCadenasANCod          	= new Array('codtipoperiodo');
...
<tr>
    ...
    <td valign="top">
        ...
        <center>
            ...
            <sql:query var="r" sql="SELECT * FROM tipoperiodo WHERE codtipoperiodo=${param.llave}" dataSource="jdbc/delphos" scope="page"/>
            </c:if>
          ...
          <table width="795" border="0" class="tablaContenido">
            <form name="formulario" id="formulario" method="post" action="TipoPeriodo.jsp">
              <span id="mensajeControlador">${msj}</span>
              <tr>
                <td colspan="3"><div align="center" class="titulo1">Tipo Per&iacute;odo</div></td>
              </tr>
              <tr>
                <td colspan="3">&nbsp;</td>
              </tr>
              <tr>
                ...
                <td width="123" class="bgDescTablas"><strong>C&oacute;digo Tipo Per&iacute;odo</strong>
                  <label></label></td>
                <td width="535" class="bgDescTablas"><input name="codtipoperiodo" type="text" id="codtipoperiodo" value="${codtipoperiodo}" size="20" maxlength="2" onKeyPress="javascript:return permite(event, 'nume')" tabindex="1">
                <label></label></td>
              </tr>
              <tr>
                <td colspan="3">&nbsp;</td>
...
<script>
    ...
    function validarPK()
    {
        llaves = 'codtipoperiodo='+document.getElementById('codtipoperiodo').value;
        //llaves+= 'codmunicipio='+document.getElementById('codmunicipio').value+',';
        validarLlave('tipoperiodo',llaves);
    } 
    ...
    function buscar()
    {
        ...
        url = url + "tabla=tipoperiodo&";
        url = url + "campos=codtipoperiodo,descripcion&";
        url = url + "campoLlave=codtipoperiodo";
