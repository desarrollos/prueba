...
<title>:: DELPHOS ::</title>
        ...
        <script type="text/javascript">
            ...
            var cajas = new Array('codgrupodiagn','descripcion','observacion');
            var combos = null;
			
            var arrayNonulos               	= new Array('codgrupodiagn');
            var arrayNumerosEnteros        	= null;
            var arrayCombos               	= null;			
            var arrayCadenasANCod          	= new Array('codgrupodiagn');
...
<tr>
    ...
    <td valign="top">
            ...
            <sql:query var="r" sql="SELECT * FROM grupodiagnostico WHERE codgrupodiagn='${param.llave}'" dataSource="jdbc/delphos" scope="page"/>
            </c:if>
		...
		<form action="GrupoDiagnostico.jsp" method="post" name="formulario" id="formulario">
                  <span id="mensajeControlador">${msj}</span>
                  <tr>
                    <td colspan="3"><div align="center" class="titulo1">Grupo Diagn&oacute;stico </div></td>
                  </tr>
                  <tr>
                    <td colspan="3">&nbsp;</td>
                  </tr>
                  <tr>
                    ...
                    <td width="112" class="bgDescTablas"><strong>C&oacute;digo Grupo Diagn&oacute;stico </strong>
                      <label></label></td>
                    <td width="546" class="bgDescTablas"><label>
                      <input name="codgrupodiagn" type="text" id="codgrupodiagn" value="${codgrupodiagn}" size="20" maxlength="6" onkeypress="javascript:return permite(event, 'num_car_cod')" tabindex="1"/>
                    </label></td>
                  </tr>
                  <tr>
...
<script>
    ...
    function validarPK()
    {
        llaves = 'codgrupodiagn='+document.getElementById('codgrupodiagn').value;
        validarLlave('grupodiagnostico',llaves);
    } 
    ...
    function buscar()
    {
        ...
        url = url + "tabla=grupodiagnostico&";
        url = url + "campos=codgrupodiagn,descripcion,observacion&";
        url = url + "campoLlave=codgrupodiagn";
