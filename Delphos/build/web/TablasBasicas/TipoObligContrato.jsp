...
<title>:: DELPHOS ::</title>
        ...
        <script type="text/javascript">
            ...
            var cajas = new Array('codtipoobligcontrato','descripcion','observacion');
            var combos = null;
            
            //validar
            var arrayNonulos               	= new Array ('codtipoobligcontrato');
            var arrayNumerosEnteros        	= null;
            var arrayCombos               	= null;
            var arrayCadenasANCod          	= new Array ('codtipoobligcontrato');
...
<tr>
    ...
    <td valign="top">
            ...
            <sql:query var="r" sql="SELECT * FROM tipoobligcontrato WHERE codtipoobligcontrato='${param.llave}'" dataSource="jdbc/delphos" scope="page"/>
            </c:if>
            <jsp2:forEach items="${r.rows}" var="fila" varStatus="contador">
              <c:set var="codtipoobligcontrato" value="${fila.codtipoobligcontrato}"/>
              <c:set var="descripcion" value="${fila.descripcion}"/>
              <c:set var="observacion" value="${fila.observacion}"/>          
            </jsp2:forEach>
                
                <table width="642" border="0" class="tablaContenido">
		<form name="formulario" id="formulario" method="post" action="TipoObligContrato.jsp">
                  <span id="mensajeControlador">${msj}</span>
                  <tr>
                    <td colspan="6"><div align="center" class="titulo1">Tipo Obligaci&oacute;n Contractual</div></td>
                  </tr>
                  <tr>
                    <td colspan="6">&nbsp;</td>
                  </tr>
                  <tr>
                    ...
                    <td width="127" class="bgDescTablas"><strong>C&oacute;digo Tipo Obligaci&oacute;n</strong></td>
                    <td width="519" colspan="4" class="bgDescTablas"><label>
                      <input name="codtipoobligcontrato" type="text" id="codtipoobligcontrato" value="${codtipoobligcontrato}" size="20" maxlength="6" onkeypress="javascript:return permite(event, 'num_car_cod')" tabindex="1"/>
                    </label></td>
                  </tr>
                  <tr>
...
<script>
    ...
    function validarPK()
    {
        llaves = 'codtipoobligcontrato='+document.getElementById('codtipoobligcontrato').value;
        //llaves+= 'codmunicipio='+document.getElementById('codmunicipio').value+',';
        validarLlave('tipoobligcontrato',llaves);
    } 
    ...
    function buscar()
    {
        ...
        url = url + "tabla=tipoobligcontrato&";
        url = url + "campos=codtipoobligcontrato,descripcion,observacion&";
        url = url + "campoLlave=codtipoobligcontrato";
