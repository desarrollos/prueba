...
<title>:: DELPHOS ::</title>
        ...
        <script type="text/javascript">
            ...
            var cajas = new Array('codclasediagnostico','descripcion','observacion');
            var combos = null;
            
            //validar
            var arrayNonulos               	= new Array('codclasediagnostico');
            var arrayNumerosEnteros        	= null;
            var arrayCombos               	= null;
            var arrayCadenasANCod          	= new Array('codclasediagnostico');
...
<tr>
    ...
    <td valign="top">
            ...
            <sql:query var="r" sql="SELECT * FROM clasediagnostico WHERE codclasediagnostico='${param.llave}'" dataSource="jdbc/delphos" scope="page"/>
            </c:if>
		...
		<form action="ClaseDiagnostico.jsp" method="post" name="formulario" id="formulario">
                  <span id="mensajeControlador">${msj}</span>
                  <tr>
                    <td colspan="3"><div align="center" class="titulo1">Clase Diagn&oacute;stico </div></td>
                  </tr>
                  <tr>
                    <td colspan="3">&nbsp;</td>
                  </tr>
                  <tr>
                    ...
                    <td width="112" class="bgDescTablas"><strong>C&oacute;digo Clase Diagn&oacute;stico </strong>
                    <label></label></td>
                    <td width="546" class="bgDescTablas"><label>
                      <input name="codclasediagnostico" type="text" id="codclasediagnostico" value="${codclasediagnostico}" size="20" maxlength="6" onkeypress="javascript:return permite(event, 'num_car_cod')" tabindex="1"/>
                    </label></td>
                  </tr>
                  <tr>
...
<script>
    ...
    function validarPK()
    {
        llaves = 'codclasediagnostico='+document.getElementById('codclasediagnostico').value;
        //llaves+= 'codmunicipio='+document.getElementById('codmunicipio').value+',';
        validarLlave('clasediagnostico',llaves);
    } 
    ...
    function buscar()
    {
        ...
        url = url + "tabla=clasediagnostico&";
        url = url + "campos=codclasediagnostico,descripcion,observacion&";
        url = url + "campoLlave=codclasediagnostico";
