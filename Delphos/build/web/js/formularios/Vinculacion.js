$(document).ready( function( ) {
    ...
    $("#ajax").ajaxStop( function() {
       ...
       // alert( op + "  " + io );
        ...
        if( op == 'eliminar_Vinculacion' ) {

            if( es == 'si' && er == 'no' ) bottomMensaje('La Inscripcion se borro correctamente', 'Estado borrado', 'ex', 's');
