...
<form method="post" id="datosPoblacion" action="SeleccionarColumnas.jsp" target="_blank"  >
    ...
    <table border="0" align="center" width="600">
        <tbody>
            <tr>
                <td>Seleccionar archivo plano</td>
                <td><input type="text" name="nombreArchivo2" id="nombreArchivo2" size="20" readonly><a href="#" onclick="abrirCargaArchivo();"><img src="../images/Buscar16x16.gif" alt="Cargar Archivo" border="0"/></a></td>
