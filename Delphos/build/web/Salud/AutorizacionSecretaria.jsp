...
<tr>
    ...
    <td valign="top">
		...
		<form action="CampoIPSEAPB.jsp" method="post" name="formulario">
                  <tr>
                    <td colspan="6"><div align="center" class="titulo1">Autorizaciones Secretaria de Salud </div></td>
                  </tr>
                  <tr>
                    <td colspan="6">&nbsp;</td>
                  </tr>
                  <tr>
                    <td width="33" class="bgDescTablas">&nbsp;</td>
                    ...
                    <td width="24">&nbsp;</td>
                    <td width="139" class="bgDescTablas"><strong>Campo Archivo</strong></td>
          <td width="163" class="sinBgDescTablas"><label>
