...
<title>:: DELPHOS ::</title>
        ...
        <script type="text/javascript">
            ...
            var cajas = new Array('codcategactividad','descripcion','observacion');
            var combos = null;
            
            //validar
            var arrayNonulos               	= new Array('codcategactividad');
            var arrayNumerosEnteros        	= null;
            var arrayCombos               	= null;
            var arrayCadenasANCod          	= new Array('codcategactividad');
...
<tr>
    ...
    <td valign="top">
            ...
            <sql:query var="r" sql="SELECT * FROM categoriaactividad WHERE codcategactividad='${param.llave}'" dataSource="jdbc/delphos" scope="page"/>
            </c:if>
		...
		<form name="formulario" id="formulario" method="post" action="CategoriaActividad.jsp">
                  <span id="mensajeControlador">${msj}</span>
                  <tr>
                    <td colspan="6"><div align="center" class="titulo1">Categor&iacute;a Actividad</div></td>
                  </tr>
                  <tr>
                    <td colspan="6">&nbsp;</td>
                  </tr>
                  <tr>
                    ...
                    <td width="129" class="bgDescTablas"><strong>C&oacute;digo Categor&iacute;a Actividad</strong></td>
                    <td width="479" colspan="4" class="bgDescTablas"><label>
                      <input name="codcategactividad" type="text" id="codcategactividad" value="${codcategactividad}" size="20" maxlength="6" onkeypress="javascript:return permite(event, 'num_car_cod')" tabindex="1"/>
                    </label></td>
                  </tr>
                  <tr>
...
<script>
    ...
    function validarPK()
    {
        llaves = 'codcategactividad='+document.getElementById('codcategactividad').value;
        //llaves+= 'codmunicipio='+document.getElementById('codmunicipio').value+',';
        validarLlave('categoriaactividad',llaves);
    } 
    ...
    function buscar()
    {
        ...
        url = url + "tabla=categoriaactividad&";
        url = url + "campos=codcategactividad,descripcion,observacion&";
        url = url + "campoLlave=codcategactividad";
