...
<title>:: DELPHOS ::</title>
        ...
        <script type="text/javascript">
            ...
            var cajas = new Array('coddiag298','descripcion','observacion');
            var combos = null;
            
            //validar
            var arrayNonulos               	= new Array('coddiag298');
            var arrayNumerosEnteros        	= null;
            var arrayCombos               	= null;
            var arrayCadenasANCod          	= new Array('coddiag298');
...
<tr>
    ...
    <td valign="top">
            ...
            <sql:query var="r" sql="SELECT * FROM diagnostico298 WHERE coddiag298='${param.llave}'" dataSource="jdbc/delphos" scope="page"/>
            </c:if>
		...
		<form name="formulario" id="formulario" method="post" action="Diagnostico298.jsp">
                  <span id="mensajeControlador">${msj}</span>
                  <tr>
                    <td colspan="3"><div align="center" class="titulo1">Diagnostico 298</div></td>
                  </tr>
                  <tr>
                    <td colspan="3">&nbsp;</td>
                  </tr>
                  <tr>
                    ...
                    <td width="105" class="bgDescTablas"><strong>C&oacute;digo Diagnostico</strong>
                    <label></label></td>
                    <td width="502" class="bgDescTablas"><input name="coddiag298" type="text" id="coddiag298" value="${coddiag298}" size="20" maxlength="4" onkeypress="javascript:return permite(event, 'num_car_cod')" tabindex="1"/>
                    <label></label></td>
              </tr>
                  <tr>
                    <td colspan="3">&nbsp;</td>
...
<script>
    ...
    function validarPK()
    {
        llaves = 'coddiag298='+document.getElementById('coddiag298').value;
        //llaves+= 'codmunicipio='+document.getElementById('codmunicipio').value+',';
        validarLlave('diagnostico298',llaves);
    } 
    ...
    function buscar()
    {
        ...
        url = url + "tabla=diagnostico298&";
        url = url + "campos=coddiag298,descripcion,observacion&";
        url = url + "campoLlave=coddiag298";
