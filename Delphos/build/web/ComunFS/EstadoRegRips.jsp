...
<title>:: DELPHOS ::</title>
        ...
        <script type="text/javascript">
            ...
            var cajas = new Array('codestregrips','descripcion');
            var combos = null;
			
			var arrayNonulos               	= new Array('codestregrips');
			var arrayNumerosEnteros        	= null;
			var arrayCombos               	= null;		
			var arrayCadenasANCod          	= new Array('codestregrips');
...
<tr>
    ...
    <td valign="top">
        ...
        <center>
            ...
            <sql:query var="r" sql="SELECT * FROM estadoregrips WHERE codestregrips='${param.llave}'" dataSource="jdbc/delphos" scope="page"/>
            </c:if>
          ...
          <table width="795" border="0" class="tablaContenido">
            <form name="formulario" id="formulario" method="post" action="EstadoRegRips.jsp">
              <span id="mensajeControlador">${msj}</span>
              <tr>
                <td colspan="3"><div align="center" class="titulo1">Estado Registro RIPS</div></td>
              </tr>
              <tr>
                <td colspan="3">&nbsp;</td>
              </tr>
              <tr>
                ...
                <td width="123" class="bgDescTablas"><strong>C&oacute;digo Estado Registro</strong>
                  <label></label></td>
                <td width="535" class="bgDescTablas"><input name="codestregrips" type="text" id="codestregrips" value="${codestregrips}" size="20" maxlength="6" onKeyPress="javascript:return permite(event, 'num_car_cod')" tabindex="1">
                </td>
              </tr>
              <tr>
                <td colspan="3">&nbsp;</td>
...
<script>
    ...
    function validarPK()
    {
        llaves = 'codestregrips='+document.getElementById('codestregrips').value;
        //llaves+= 'codmunicipio='+document.getElementById('codmunicipio').value+',';
        validarLlave('estadoregrips',llaves);
    } 
    ...
    function buscar()
    {
        ...
        url = url + "tabla=estadoregrips&";
        url = url + "campos=codestregrips,descripcion&";
        url = url + "campoLlave=codestregrips";
