...
<title>:: DELPHOS ::</title>
        ...
        <script type="text/javascript">
            ...
            var cajas = new Array('codtipocausatrasl','descripcion');
            var combos = null;
            
            //validar
            var arrayNonulos               	= new Array ('codtipocausatrasl');
            var arrayNumerosEnteros        	= null;
            var arrayCombos               	= null;
            var arrayCadenasANCod          	= new Array ('codtipocausatrasl');
...
<tr>
    ...
    <td valign="top">
            ...
            <sql:query var="r" sql="SELECT * FROM tipocausatraslado WHERE codtipocausatrasl='${param.llave}'" dataSource="jdbc/delphos" scope="page"/>
            </c:if>
		...
		<form name="formulario" id="formulario" method="post" action="TipoCausaTraslado.jsp">
                  <span id="mensajeControlador">${msj}</span>
                  <tr>
                    <td colspan="3"><div align="center" class="titulo1">Tipo Causal Traslado</div></td>
                  </tr>
                  <tr>
                    <td colspan="3">&nbsp;</td>
                  </tr>
                  <tr>
                    ...
                    <label><strong>Tipo Causal</strong></label></td>
                    <td width="505" class="bgDescTablas">
                        <input name="codtipocausatrasl" type="text" id="codtipocausatrasl" value="${codtipocausatrasl}" size="20" maxlength="6" onkeypress="javascript:return permite(event, 'num_car_cod')" tabindex="1"/>                    </td>
                  </tr>
                  <tr>
...
<script>
    ...
    function validarPK()
    {
        ...
        validarLlave('tipocausatraslado',llaves);
    } 
    ...
    function buscar()
    {
        ...
        url = url + "tabla=tipocausatraslado&";
        url = url + "campos=codtipocausatrasl,descripcion&";
        url = url + "campoLlave=codtipocausatrasl";
