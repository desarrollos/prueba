...
<title>:: DELPHOS ::</title>
        ...
        <script type="text/javascript">
            ...
            var cajas = new Array('codproceso','descripcion');
            var combos = null;
			
            var arrayNonulos               	= new Array('codproceso');
            var arrayNumerosEnteros        	= null;
            var arrayCombos               	= null;		
            var arrayCadenasANCod          	= new Array('codproceso');
...
<tr>
    ...
    <td valign="top">
        ...
        <center>
            ...
            <sql:query var="r" sql="SELECT * FROM listaproceso WHERE codproceso='${param.llave}'" dataSource="jdbc/delphos" scope="page"/>
            </c:if>
          ...
          <table width="778" border="0" class="tablaContenido">
            <form name="formulario" id="formulario" method="post" action="ListaProceso.jsp">
              <span id="mensajeControlador">${msj}</span>
              <tr>
                <td colspan="3"><div align="center" class="titulo1">Lista Procesos</div></td>
              </tr>
              <tr>
                <td colspan="3">&nbsp;</td>
              </tr>
              <tr>
                ...
                <td width="106" class="bgDescTablas"><strong>C&oacute;digo Proceso</strong>
                  <label></label></td>
                <td width="552" class="bgDescTablas"><input name="codproceso" type="text" id="codproceso" value="${codproceso}" size="20" maxlength="6" onKeyPress="javascript:return permite(event, 'num_car_cod')" tabindex="1">
                </td>
              </tr>
              <tr>
                <td colspan="3">&nbsp;</td>
...
<script>
    ...
    function validarPK()
    {
        ...
        validarLlave('listaproceso',llaves);
    } 
    ...
    function buscar()
    {
        ...
        url = url + "tabla=listaproceso&";
        url = url + "campos=codproceso,descripcion&";
        url = url + "campoLlave=codproceso";
