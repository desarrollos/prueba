...
<title>:: DELPHOS ::</title>
        ...
        <script type="text/javascript">
            ...
            var combos = new Array('codtiponovedads','codcampoarchivos','codregimens');
			
            var arrayNonulos               	= null;
            var arrayNumerosEnteros        	= null;
            var arrayCombos               	= new Array('codtiponovedads','codcampoarchivos','codregimens');			
...
<tr>
    ...
    <td valign="top">
                <center>
            <c:if test='${param.codtiponovedad != null && param.codcampoarchivo != null && param.codregimen != null && param.codcampoarchivo != ""}'>
            <sql:query var="r" sql="SELECT * FROM estructnovedades WHERE codtiponovedad='${param.codtiponovedad}' AND codcampoarchivo=${param.codcampoarchivo} AND codregimen='${param.codregimen}'" dataSource="jdbc/delphos" scope="page"/>
            </c:if>
            <jsp2:forEach items="${r.rows}" var="fila" varStatus="contador">
              ...
              <c:set var="observacion" value="${fila.observacion}"/>       
                ...
                <table width="780" border="0" class="tablaContenido">
		<form name="formulario" id="formulario" method="post" action="EstructNovedades.jsp">
                  <span id="mensajeControlador">${msj}</span>
                  <tr>
                    <td colspan="6"><div align="center" class="titulo1">Estructura C&oacute;digo Novedades</div></td>
                  </tr>
                  <tr>
                    <td colspan="6">&nbsp;</td>
                  </tr>
                  <tr>
                    ...
                    <td width="108" class="bgDescTablas"><strong>Tipo Novedad</strong></td>
                    ...
                    <td width="111" class="bgDescTablas"><strong>Campo Archivo</strong></td>
                    <td width="187" class="bgDescTablas"><label>
                      <select name="codcampoarchivos" id="codcampoarchivos" style="width: 150px" tabindex="2">
                  ...
                  <tr>
                    ...
                    <td colspan="4" class="bgDescTablas"><label>
                      <select name="codregimens" id="codregimens" style="width: 150px" tabindex="3">
...
<script>
    ...
    { 
        ...
        validarLlave('estructnovedades',llaves);
    } 
    ...
    function buscar()
    {
        ...
        url = url + "tabla=estructnovedades&";
        url = url + "campos=codtiponovedad,codcampoarchivo,codregimen,observacion&";
        url = url + "campoLlave=codtiponovedad,codcampoarchivo,codregimen";
