...
<title>:: DELPHOS ::</title>
        ...
        <script type="text/javascript">
            ...
            var cajas =  new Array('codeventoepidem','descripcion','observacion');
            var combos = null;
			
            var arrayNonulos               	= new Array('codeventoepidem');
            var arrayNumerosEnteros        	= null;
            var arrayCombos               	= null;			
            var arrayCadenasANCod          	= new Array('codeventoepidem');
...
<tr>
    ...
    <td valign="top">
            ...
            <sql:query var="r" sql="SELECT * FROM eventoepidemiologico WHERE codeventoepidem='${param.llave}'" dataSource="jdbc/delphos" scope="page"/>
            </c:if>
		...
		<form action="EventoEpidemiologico.jsp" method="post" name="formulario" id="formulario">
                  <span id="mensajeControlador">${msj}</span>
                  <tr>
                    <td colspan="3"><div align="center" class="titulo1">Evento Epidemiol&oacute;gico </div></td>
                  </tr>
                  <tr>
                    <td colspan="3">&nbsp;</td>
                  </tr>
                  <tr>
                    ...
                    <td width="112" class="bgDescTablas"><strong>C&oacute;digo Evento Epidemiol&oacute;gico </strong>
                      <label></label></td>
                    <td width="546" class="bgDescTablas"><label>
                      <input name="codeventoepidem" type="text" id="codeventoepidem" value="${codeventoepidem}" size="20" maxlength="6" onkeypress="javascript:return permite(event, 'num_car_cod')" tabindex="1"/>
                    </label></td>
                  </tr>
                  <tr>
...
<script>
    ...
    function validarPK()
    {
        llaves = 'codeventoepidem='+document.getElementById('codeventoepidem').value;
        //llaves+= 'codmunicipio='+document.getElementById('codmunicipio').value+',';
        validarLlave('eventoepidemiologico',llaves);
    } 
    ...
    function buscar()
    {
        ...
        url = url + "tabla=eventoepidemiologico&";
        url = url + "campos=codeventoepidem,descripcion,observacion&";
        url = url + "campoLlave=codeventoepidem";
