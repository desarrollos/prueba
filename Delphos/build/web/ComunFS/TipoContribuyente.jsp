...
<title>:: DELPHOS ::</title>
        ...
        <script type="text/javascript">
            ...
            var cajas = new Array('codtipocontribuyente','descripcion','observacion');
            var combos = null;
            
            //validar
            var arrayNonulos               	= new Array('codtipocontribuyente');
            var arrayNumerosEnteros        	= null;
            var arrayCombos               	= null;
            var arrayCadenasANCod          	= new Array('codtipocontribuyente');
...
<tr>
    ...
    <td valign="top">
        ...
        <center>
            ...
            <sql:query var="r" sql="SELECT * FROM tipocontribuyente WHERE codtipocontribuyente='${param.llave}'" dataSource="jdbc/delphos" scope="page"/>
            </c:if>
          ...
          <table width="795" border="0" class="tablaContenido">
            <form name="formulario" id="formulario" method="post" action="TipoContribuyente.jsp">
              <span id="mensajeControlador">${msj}</span>
              <tr>
                <td colspan="3"><div align="center" class="titulo1">Tipo Contribuyente</div></td>
              </tr>
              <tr>
                <td colspan="3">&nbsp;</td>
              </tr>
              <tr>
                ...
                <td width="123" class="bgDescTablas"><strong>C&oacute;digo Tipo Contribuyente</strong>
                  <label></label></td>
                <td width="535" class="bgDescTablas"><input name="codtipocontribuyente" type="text" id="codtipocontribuyente" value="${codtipocontribuyente}" size="20" maxlength="6" onKeyPress="javascript:return permite(event, 'num_car_cod')" tabindex="1">
                <label></label></td>
              </tr>
              <tr>
                <td colspan="3">&nbsp;</td>
...
<script>
    ...
    function validarPK()
    {
        llaves = 'codtipocontribuyente='+document.getElementById('codtipocontribuyente').value;
        //llaves+= 'codmunicipio='+document.getElementById('codmunicipio').value+',';
        validarLlave('tipocontribuyente',llaves);
    } 
    ...
    function buscar()
    {
        ...
        url = url + "tabla=tipocontribuyente&";
        url = url + "campos=codtipocontribuyente,descripcion,observacion&";
        url = url + "campoLlave=codtipocontribuyente";
