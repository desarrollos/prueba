...
<title>:: DELPHOS ::</title>
        ...
        <script type="text/javascript">
            ...
            var cajas = new Array('codtipoproveedor','descripcion','observacion');
            var combos = null;
            
            //validar
            var arrayNonulos               	= new Array('codtipoproveedor');
            var arrayNumerosEnteros        	= null;
            var arrayCombos               	= null;
            var arrayCadenasANCod          	= new Array('codtipoproveedor');
...
<tr>
    ...
    <td valign="top">
            ...
            <sql:query var="r" sql="SELECT * FROM tipoproveedor WHERE codtipoproveedor='${param.llave}'" dataSource="jdbc/delphos" scope="page"/>
            </c:if>
		...
		<form name="formulario" id="formulario" method="post" action="TipoProveedor.jsp">
                  <span id="mensajeControlador">${msj}</span>
                  <tr>
                    <td colspan="3"><div align="center" class="titulo1">Tipo Proveedor</div></td>
                  </tr>
                  <tr>
                    <td colspan="3">&nbsp;</td>
                  </tr>
                  <tr>
                    ...
                    <td width="102" class="bgDescTablas"><strong>C&oacute;digo Tipo Proveedor</strong>
                      <label></label></td>
                    <td width="530" class="bgDescTablas"><input name="codtipoproveedor" type="text" id="codtipoproveedor" value="${codtipoproveedor}" size="20" maxlength="4" onkeypress="javascript:return permite(event, 'num_car_cod')" tabindex="1"/>
                    <label></label></td>
              </tr>
                  <tr>
                    <td colspan="3">&nbsp;</td>
...
<script>
    ...
    function validarPK()
    {
        llaves = 'codtipoproveedor='+document.getElementById('codtipoproveedor').value;
        //llaves+= 'codmunicipio='+document.getElementById('codmunicipio').value+',';
        validarLlave('tipoproveedor',llaves);
    } 
    ...
    function buscar()
    {
        ...
        url = url + "tabla=tipoproveedor&";
        url = url + "campos=codtipoproveedor,descripcion,observacion&";
        url = url + "campoLlave=codtipoproveedor";
