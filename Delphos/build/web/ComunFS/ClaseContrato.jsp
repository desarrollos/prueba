...
<title>:: DELPHOS ::</title>
        ...
        <script type="text/javascript">
            ...
            var cajas = new Array('codclasecontrato','descripcion');
            var combos = null;
                       
            //validar
            var arrayNonulos               	= new Array ('codclasecontrato');
            var arrayNumerosEnteros        	= null;
            var arrayCombos               	= null;
            var arrayCadenasANCod          	= new Array ('codclasecontrato');
...
<tr>
    ...
    <td valign="top">
            ...
            <sql:query var="r" sql="SELECT * FROM clasecontrato WHERE codclasecontrato='${param.llave}'" dataSource="jdbc/delphos" scope="page"/>
            </c:if>
		...
		<form name="formulario" id="formulario" method="post" action="ClaseContrato.jsp">
                  <span id="mensajeControlador">${msj}</span>
                  <tr>
                    <td colspan="6"><div align="center" class="titulo1">Clase Contrato</div></td>
                  </tr>
                  <tr>
                    <td colspan="6">&nbsp;</td>
                  </tr>
                  <tr>
                    ...
                    <td width="127" class="bgDescTablas"><strong>C&oacute;digo Clase Contrato</strong></td>
                    <td width="519" colspan="4" class="bgDescTablas"><label>
                      <input name="codclasecontrato" type="text" id="codclasecontrato" value="${codclasecontrato}" size="20" maxlength="6" onkeypress="javascript:return permite(event, 'num_car_cod')" tabindex="1"/>
                    </label></td>
                  </tr>
                  <tr>
...
<script>
    ...
    function validarPK()
    {
        llaves = 'codclasecontrato='+document.getElementById('codclasecontrato').value;
        //llaves+= 'codmunicipio='+document.getElementById('codmunicipio').value+',';
        validarLlave('clasecontrato',llaves);
    } 
    ...
    function buscar()
    {
        ...
        url = url + "tabla=clasecontrato&";
        url = url + "campos=codclasecontrato,descripcion&";
        url = url + "campoLlave=codclasecontrato";
