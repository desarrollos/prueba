...
public class Contrato implements Control{
        ...
        if(request.getParameter("hacerSubmit") != null && !request.getParameter("hacerSubmit").equals("0"))
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    stmt.setString(3,request.getParameter("codcontrato"));
                    msj = "eliminada";
                }                
                ...
                if( !request.getParameter("hacerSubmit").equals("3") )
                {
                    ...
                    stmt.setInt(33,Integer.parseInt(request.getParameter("usuarioscontrato")));
                    ...
                    stmt.setString(38,request.getParameter("codcontrato"));
