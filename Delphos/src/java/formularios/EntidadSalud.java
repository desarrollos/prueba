...
public class EntidadSalud extends HttpServlet {
    ...
    private boolean existe_entidadsalud() {
        ...
        boolean existe = true;
        try {
            pQuery = conexion.prepareStatement("SELECT COUNT(*) FROM entidadsalud  "
                    + "WHERE codregimenes = '" + dkda.o(vars, "codregimenes_entidadsalud") + "'" + " "
                    + "AND codentidadsalud = '" + dkda.o(vars, "codentidadsalud_entidadsalud") + "'");
    ...
    public String obtener_entidadsalud(ConexionBaseDatos con, String codigo) {
        ...
        try {
            ...
            System.out.println( "PRUEBA : " + rs.getString("entidadsalud_archivofi2_nombre") );
