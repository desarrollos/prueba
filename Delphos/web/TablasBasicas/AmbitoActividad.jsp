...
<title>:: DELPHOS ::</title>
        ...
        <script type="text/javascript">
            ...
            var cajas = new Array('codambito','descripcion','observacion');
            var combos = null;
                       
            //validar
            var arrayNonulos               	= new Array('codambito');
            var arrayNumerosEnteros        	= null;
            var arrayCombos               	= null;
            var arrayCadenasANCod          	= new Array('codambito');
...
<tr>
    ...
    <td valign="top">
            ...
            <sql:query var="r" sql="SELECT * FROM ambitoactividad WHERE codambito='${param.llave}'" dataSource="jdbc/delphos" scope="page"/>
            </c:if>
		...
		<form name="formulario" id="formulario" method="post" action="AmbitoActividad.jsp">
                  <span id="mensajeControlador">${msj}</span>
                  <tr>
                    <td colspan="6"><div align="center" class="titulo1">Ambito Actividad</div></td>
                  </tr>
                  <tr>
                    <td colspan="6">&nbsp;</td>
                  </tr>
                  <tr>
                    ...
                    <td width="127" class="bgDescTablas"><strong>C&oacute;digo Ambito</strong></td>
                    <td width="519" colspan="4" class="bgDescTablas"><label>
                      <input name="codambito" type="text" id="codambito" value="${codambito}" size="20" maxlength="6" onkeypress="javascript:return permite(event, 'num_car_cod')" tabindex="1"/>
                    </label></td>
                  </tr>
                  <tr>
...
<script>
    ...
    function validarPK()
    {
        llaves = 'codambito='+document.getElementById('codambito').value;
        //llaves+= 'codmunicipio='+document.getElementById('codmunicipio').value+',';
        validarLlave('ambitoactividad',llaves);
    } 
    ...
    function buscar()
    {
        ...
        url = url + "tabla=ambitoactividad&";
        url = url + "campos=codambito,descripcion,observacion&";
        url = url + "campoLlave=codambito";
