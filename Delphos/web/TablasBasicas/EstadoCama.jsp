...
<title>:: DELPHOS ::</title>
        ...
        <script type="text/javascript">
            ...
            var cajas = new Array('codestadocama','descripcion');
            var combos = null;
			
			var arrayNonulos               	= new Array ('codestadocama');
			var arrayNumerosEnteros        	= null;
			var arrayCombos               	= null;			
			var arrayCadenasANCod          	= new Array ('codestadocama');
...
<tr>
    ...
    <td valign="top">
            ...
            <sql:query var="r" sql="SELECT * FROM estadocama WHERE codestadocama='${param.llave}'" dataSource="jdbc/delphos" scope="page"/>
            </c:if>
		...
		<form name="formulario" id="formulario" method="post" action="EstadoCama.jsp">
                  <span id="mensajeControlador">${msj}</span>
                  tr>
                    <td colspan="6"><div align="center" class="titulo1">Estado Cama</div></td>
                  </tr>
                  <tr>
                    <td colspan="6">&nbsp;</td>
                  </tr>
                  <tr>
                    ...
                    <td width="153" class="bgDescTablas"><strong>C&oacute;digo Estado Cama</strong></td>
                    <td width="456" colspan="4" class="bgDescTablas"><label>
                      <input name="codestadocama" type="text" id="codestadocama" value="${codestadocama}" size="20" maxlength="6" onkeypress="javascript:return permite(event, 'num_car_cod')" tabindex="1"/>
                    </label></td>
                  </tr>
                  <tr>
...
<script>
    ...
    function validarPK()
    {
        llaves = 'codestadocama='+document.getElementById('codestadocama').value;
        //llaves+= 'codmunicipio='+document.getElementById('codmunicipio').value+',';
        validarLlave('estadocama',llaves);
    } 
    ...
    function buscar()
    {
        ...
        url = url + "tabla=estadocama&";
        url = url + "campos=codestadocama,descripcion&";
        url = url + "campoLlave=codestadocama";
