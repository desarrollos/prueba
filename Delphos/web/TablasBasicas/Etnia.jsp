...
<title>:: DELPHOS ::</title>
        ...
        <script type="text/javascript">
            ...
            var cajas = new Array('codetnia','descripcion');
            var combos = null;

            var arrayNonulos               	= new Array ('codetnia');
            var arrayNumerosEnteros        	= null;
            var arrayCombos               	= null;	
            var arrayCadenasANCod          	= new Array ('codetnia');
...
<tr>
    ...
    <td valign="top">
            ...
            <sql:query var="r" sql="SELECT * FROM etnia WHERE codetnia='${param.llave}'" dataSource="jdbc/delphos" scope="page"/>
            </c:if>
            <jsp2:forEach items="${r.rows}" var="fila" varStatus="contador">
              <c:set var="codetnia" value="${fila.codetnia}"/>
              <c:set var="descripcion" value="${fila.descripcion}"/>         
            </jsp2:forEach>
                
                <table width="642" border="0" class="tablaContenido">
		<form name="formulario" id="formulario" method="post" action="Etnia.jsp">
                  <span id="mensajeControlador">${msj}</span>
                  <tr>
                    <td colspan="6"><div align="center" class="titulo1">Grupo Etnico</div></td>
                  </tr>
                  <tr>
                    <td colspan="6">&nbsp;</td>
                  </tr>
                  <tr>
                    ...
                    <td width="127" class="bgDescTablas"><strong>C&oacute;digo Grupo Etnico</strong></td>
                    <td width="519" colspan="4" class="bgDescTablas"><label>
                      <input name="codetnia" type="text" id="codetnia" value="${codetnia}" size="20" maxlength="10" onkeypress="javascript:return permite(event, 'num_car_cod')" tabindex="1"/>
                    </label></td>
                  </tr>
                  <tr>
...
<script>
    ...
    function validarPK()
    {
        llaves = 'codetnia='+document.getElementById('codetnia').value;
        //llaves+= 'codmunicipio='+document.getElementById('codmunicipio').value+',';
        validarLlave('etnia',llaves);
    } 
    ...
    function buscar()
    {
        ...
        url = url + "tabla=etnia&";
        url = url + "campos=codetnia,descripcion&";
        url = url + "campoLlave=codetnia";
