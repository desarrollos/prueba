...
<title>:: DELPHOS ::</title>
        ...
        <script type="text/javascript">
            ...
            var cajas = new Array('codmodalidadcontrato','descripcion','observacion');
            var combos = null;
			
            var arrayNonulos               	= new Array ('codmodalidadcontrato');
            var arrayNumerosEnteros        	= null;
            var arrayCombos               	= null;			
            var arrayCadenasANCod          	= new Array ('codmodalidadcontrato');
...
<tr>
    ...
    <td valign="top">
            ...
            <sql:query var="r" sql="SELECT * FROM modalidadcontrato WHERE codmodalidadcontrato='${param.llave}'" dataSource="jdbc/delphos" scope="page"/>
            </c:if>
		...
		<form name="formulario" id="formulario" method="post" action="ModalidadContrato.jsp">
                  <span id="mensajeControlador">${msj}</span>
                  <tr>
                    <td colspan="6"><div align="center" class="titulo1">Modalidad Contrato</div></td>
                  </tr>
                  <tr>
                    <td colspan="6">&nbsp;</td>
                  </tr>
                  <tr>
                    ...
                    <td width="127" class="bgDescTablas"><strong>C&oacute;digo Modalidad Contrato</strong></td>
                    <td width="519" colspan="4" class="bgDescTablas"><label>
                      <input name="codmodalidadcontrato" type="text" id="codmodalidadcontrato" value="${codmodalidadcontrato}" size="20" maxlength="6" onkeypress="javascript:return permite(event, 'num_car_cod')" tabindex="1"/>
                    </label></td>
                  </tr>
                  <tr>
...
<script>
    ...
    function validarPK()
    {
        ...
        validarLlave('modalidadcontrato',llaves);
    } 
    ...
    function buscar()
    {
        ...
        url = url + "tabla=modalidadcontrato&";
        url = url + "campos=codmodalidadcontrato,descripcion,observacion&";
