...
<title>:: DELPHOS ::</title>
        ...
        <script type="text/javascript">
            ...
            var cajas = new Array('codtiponovedad','descripcion','observacion');
            var combos = null;
            
            //validar
            var arrayNonulos               	= new Array ('codtiponovedad');
            var arrayNumerosEnteros        	= null;
            var arrayCombos               	= null;
            var arrayCadenasANCod          	= new Array ('codtiponovedad');
...
<tr>
    ...
    <td valign="top">
            ...
            <sql:query var="r" sql="SELECT * FROM tiponovedad WHERE codtiponovedad='${param.llave}'" dataSource="jdbc/delphos" scope="page"/>
            </c:if>
		...
		<form name="formulario" id="formulario" method="post" action="TipoNovedad.jsp">
                  <span id="mensajeControlador">${msj}</span>
                  <tr>
                    <td colspan="3"><div align="center" class="titulo1">Tipo Novedad</div></td>
                  </tr>
                  <tr>
                    <td colspan="3">&nbsp;</td>
                  </tr>
                  <tr>
                    ...
                    <td width="151" class="bgDescTablas"><strong>C&oacute;digo </strong>
                    <label><strong>Tipo Novedad</strong></label></td>
                    <td width="458" class="bgDescTablas">
                        <input name="codtiponovedad" type="text" id="codtiponovedad" value="${codtiponovedad}" size="20" maxlength="6" onkeypress="javascript:return permite(event, 'num_car_cod')" tabindex="1"/>                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td colspan="3" class="bgDescTablas"><p align="center"><strong>Descripci&oacute;n</strong></p>
                      <p align="center">
                        <input name="descripcion" type="text" id="descripcion" value="${descripcion}" size="75" maxlength="100" onkeypress="javascript:return permite(event, 'com')" tabindex="2"/>
                      </p></td>
                  </tr>
                  <tr>
...
<script>
    ...
    function validarPK()
    {
        ...
        validarLlave('tiponovedad',llaves);
    } 
    ...
    function buscar()
    {
        ...
        url = url + "tabla=tiponovedad&";
        url = url + "campos=codtiponovedad,descripcion,observacion&";
        url = url + "campoLlave=codtiponovedad";
