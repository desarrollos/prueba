...
<title>:: DELPHOS ::</title>
        ...
        <script type="text/javascript">
            ...
            var cajas = new Array('codestadocontrato','descripcion');
            var combos = null;
			
			var arrayNonulos               = new Array('codestadocontrato');
            var arrayNumerosEnteros        = null;
            var arrayCombos                = null;
            var arrayCadenasANCod          = new Array('codestadocontrato');
...
<tr>
    ...
    <td valign="top">
            ...
            <sql:query var="r" sql="SELECT * FROM estadocontrato WHERE codestadocontrato='${param.llave}'" dataSource="jdbc/delphos" scope="page"/>
            </c:if>
		...
		<form name="formulario" id="formulario" method="post" action="EstadoContrato.jsp">
                 <span id="mensajeControlador">${msj}</span>
                  <tr>
                    <td colspan="6"><div align="center" class="titulo1">Estado Contrato</div></td>
                  </tr>
                  <tr>
                    <td colspan="6">&nbsp;</td>
                  </tr>
                  <tr>
                    ...
                    <td width="127" class="bgDescTablas"><strong>C&oacute;digo Estado Contrato</strong></td>
                    <td width="519" colspan="4" class="bgDescTablas"><label>
                      <input name="codestadocontrato" type="text" id="codestadocontrato" value="${codestadocontrato}" size="20" maxlength="6" onkeypress="javascript:return permite(event, 'num_car_cod')" tabindex="1"/>
                    </label></td>
                  </tr>
                  <tr>
...
<script>
    ...
    function validarPK()
    {
        llaves = 'codestadocontrato='+document.getElementById('codestadocontrato').value;
        //llaves+= 'codmunicipio='+document.getElementById('codmunicipio').value+',';
        validarLlave('estadocontrato',llaves);
    } 
    ...
    function buscar()
    {
        ...
        url = url + "tabla=estadocontrato&";
        url = url + "campos=codestadocontrato,descripcion&";
        url = url + "campoLlave=codestadocontrato";
