...
<title>:: DELPHOS ::</title>
        ...
        <script type="text/javascript">
            ...
            var cajas = new Array('codtipopoliza','descripcion','observacion');
            var combos = null;
            
            //validar
            var arrayNonulos               	= new Array ('codtipopoliza');
            var arrayNumerosEnteros        	= null;
            var arrayCombos               	= null;
            var arrayCadenasANCod          	= new Array ('codtipopoliza');
...
<tr>
    ...
    <td valign="top">
            ...
            <sql:query var="r" sql="SELECT * FROM tipopoliza WHERE codtipopoliza='${param.llave}'" dataSource="jdbc/delphos" scope="page"/>
            </c:if>
		...
		<form name="formulario" id="formulario" method="post" action="TipoPoliza.jsp">
                  <span id="mensajeControlador">${msj}</span>
                  <tr>
                    <td colspan="6"><div align="center" class="titulo1">Tipo P&oacute;liza</div></td>
                  </tr>
                  <tr>
                    <td colspan="6">&nbsp;</td>
                  </tr>
                  <tr>
                    ...
                    <td width="126" class="bgDescTablas"><strong>C&oacute;digo Tipo P&oacute;liza</strong></td>
                    <td width="482" colspan="4" class="bgDescTablas"><label>
                      <input name="codtipopoliza" type="text" id="codtipopoliza" value="${codtipopoliza}" size="20" maxlength="10" onkeypress="javascript:return permite(event, 'num_car_cod')" tabindex="1"/>
                    </label></td>
                  </tr>
                  <tr>
...
<script>
    ...
    function validarPK()
    {
        llaves = 'codtipopoliza='+document.getElementById('codtipopoliza').value;
        //llaves+= 'codmunicipio='+document.getElementById('codmunicipio').value+',';
        validarLlave('tipopoliza',llaves);
    } 
    ...
    function buscar()
    {
        ...
        url = url + "tabla=tipopoliza&";
        url = url + "campos=codtipopoliza,descripcion,observacion&";
        url = url + "campoLlave=codtipopoliza";
