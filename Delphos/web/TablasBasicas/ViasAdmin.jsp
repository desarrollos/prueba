...
<title>:: DELPHOS ::</title>
        ...
        <script type="text/javascript">
            ...
            var cajas = new Array('codviaadmin','descripcion','codalterno');
            var combos = null;
            
            //validar
            var arrayNonulos               	= new Array('codviaadmin');
            var arrayNumerosEnteros        	= null;
            var arrayCombos               	= null;
            var arrayCadenasANCod          	= new Array('codviaadmin','codalterno');
...
<tr>
    ...
    <td valign="top">
            ...
            <sql:query var="r" sql="SELECT * FROM viasadmin WHERE codviaadmin='${param.llave}'" dataSource="jdbc/delphos" scope="page"/>
            </c:if>
		...
		<form action="ViasAdmin.jsp" method="post" name="formulario" id="formulario">
                  <span id="mensajeControlador">${msj}</span>
                  <tr>
                    <td colspan="6"><div align="center" class="titulo1">V&iacute;as de Administraci&oacute;n</div></td>
                  </tr>
                  <tr>
                    <td colspan="6">&nbsp;</td>
                  </tr>
                  <tr>
                    ...
                    <td width="130" class="bgDescTablas"><strong>C&oacute;digo V&iacute;a Administraci&oacute;n</strong>
                      <label></label></td>
                    <td width="149" class="bgDescTablas"><input name="codviaadmin" type="text" id="codviaadmin" value="${codviaadmin}" size="20" maxlength="6" onkeypress="javascript:return permite(event, 'num_car_cod')" tabindex="1"/></td>
                    <td width="26" class="bgDescTablas">&nbsp;</td>
                    <td width="126" class="bgDescTablas"><strong>C&oacute;digo Alterno</strong></td>
...
<script>
    ...
    function validarPK()
    {
        llaves = 'codviaadmin='+document.getElementById('codviaadmin').value;
        //llaves+= 'codmunicipio='+document.getElementById('codmunicipio').value+',';
        validarLlave('viasadmin',llaves);
    } 
    ...
    function buscar()
    {
        ...
        url = url + "tabla=viasadmin&";
        url = url + "campos=codviaadmin,descripcion,codalterno&";
        url = url + "campoLlave=codviaadmin";
