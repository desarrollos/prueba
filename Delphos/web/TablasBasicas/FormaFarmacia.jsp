...
<title>:: DELPHOS ::</title>
        ...
        <script type="text/javascript">
            ...
            var cajas = new Array('codformafarmac','codalterno','descripcion','observacion');
            var combos = null;
			
            var arrayNonulos               	= new Array('codformafarmac');
            var arrayNumerosEnteros        	= null;
            var arrayCombos               	= null;			
            var arrayCadenasANCod          	= new Array('codformafarmac','codalterno');
...
<tr>
    ...
    <td valign="top">
            ...
            <sql:query var="r" sql="SELECT * FROM formafarmacia WHERE codformafarmac='${param.llave}'" dataSource="jdbc/delphos" scope="page"/>
            </c:if>
		...
		<form name="formulario" id="formulario" method="post" action="FormaFarmacia.jsp">
                  <span id="mensajeControlador">${msj}</span>
                  <tr>
                    <td colspan="9"><div align="center" class="titulo1">Forma Farmaceutica</div></td>
                  </tr>
                  <tr>
                    <td colspan="9">&nbsp;</td>
                  </tr>
                  <tr>
                    ...
                    <td width="140" class="bgDescTablas"><strong>C&oacute;digo Forma Farmaceutica</strong></td>
                    <td width="163" class="bgDescTablas"><input name="codformafarmac" type="text" id="codformafarmac" value="${codformafarmac}" size="20" maxlength="6" onkeypress="javascript:return permite(event, 'num_car_cod')" tabindex="1"/></td>
                    <td width="15" class="bgDescTablas">&nbsp;</td>
                    <td class="bgDescTablas"><strong>C&oacute;digo Alterno</strong></td>
                    <td width="163" colspan="4" class="bgDescTablas"><label>
...
<script>
    ...
    function validarPK()
    {
        llaves = 'codformafarmac='+document.getElementById('codformafarmac').value;
        //llaves+= 'codmunicipio='+document.getElementById('codmunicipio').value+',';
        validarLlave('formafarmacia',llaves);
    } 
    ...
    function buscar()
    {
        ...
        url = url + "tabla=formafarmacia&";
        url = url + "campos=codformafarmac,codalterno,descripcion,observacion&";
        url = url + "campoLlave=codformafarmac";
