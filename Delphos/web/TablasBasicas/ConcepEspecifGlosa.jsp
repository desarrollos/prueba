...
<title>:: DELPHOS ::</title>
        ...
        <script type="text/javascript">
            ...
            var cajas = new Array('codconcepespecifglosa','descripcion','aplicacion');
            var combos = null;
                        
            //validar          
            var arrayNonulos               	= new Array ('codconcepespecifglosa');
            var arrayNumerosEnteros        	= null;
            var arrayCombos               	= null;
            var arrayCadenasANCod          	= new Array ('codconcepespecifglosa');
            var arrayCadenasA              	= null;
            var arrayComentarios           	= new Array ('descripcion','aplicacion');
...
<tr>
    ...
    <td valign="top">
            ...
            <sql:query var="r" sql="SELECT * FROM concepespecifglosa WHERE codconcepespecifglosa='${param.llave}'" dataSource="jdbc/delphos" scope="page"/>
            </c:if>
		...
		<form name="formulario" id="formulario" method="post" action="ConcepEspecifGlosa.jsp">
                  <span id="mensajeControlador">${msj}</span>
                  <tr>
                    <td colspan="6"><div align="center" class="titulo1">Concepto Espec&iacute;fico Glosa</div></td>
                  </tr>
                  <tr>
                    <td colspan="6">&nbsp;</td>
                  </tr>
                  <tr>
                    ...
                    <td width="127" class="bgDescTablas"><strong>C&oacute;digo Tipo Concepto</strong></td>
                    <td width="519" colspan="4" class="bgDescTablas"><label>
                      <input name="codconcepespecifglosa" type="text" id="codconcepespecifglosa" value="${codconcepespecifglosa}" size="20" maxlength="6" onkeypress="javascript:return permite(event, 'num_car_cod')" tabindex="1"/>
                    </label></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td colspan="6"><p align="center" class="bgDescTablas"><strong>Aplicaci&oacute;n</strong></p>
...
<script>
    ...
    function validarPK()
    {
        ...
        validarLlave('concepespecifglosa',llaves);
    } 
    ...
    function buscar()
    {
        ...
        url = url + "tabla=concepespecifglosa&";
        url = url + "campos=codconcepespecifglosa,descripcion,aplicacion&";
        url = url + "campoLlave=codconcepespecifglosa";
