...
<title>:: DELPHOS ::</title>
        ...
        <script type="text/javascript">
            ...
            var cajas = new Array('codtipofasecontrato','descripcion','observacion');
            var combos = null;
            
            //validar
            var arrayNonulos               	= new Array ('codtipofasecontrato');
            var arrayNumerosEnteros        	= null;
            var arrayCombos               	= null;
            var arrayCadenasANCod          	= new Array ('codtipofasecontrato');
...
<tr>
    ...
    <td valign="top">
            ...
            <sql:query var="r" sql="SELECT * FROM tipofasecontrato WHERE codtipofasecontrato='${param.llave}'" dataSource="jdbc/delphos" scope="page"/>
            </c:if>
		...
		<form name="formulario" id="formulario" method="post" action="TipoFaseContrato.jsp">
                  <span id="mensajeControlador">${msj}</span>
                  <tr>
                    <td colspan="6"><div align="center" class="titulo1">Tipo Fase Contrato</div></td>
                  </tr>
                  <tr>
                    <td colspan="6">&nbsp;</td>
                  </tr>
                  <tr>
                    ...
                    <td width="127" class="bgDescTablas"><strong>C&oacute;digo Tipo Fase Contrato</strong></td>
                    <td width="519" colspan="4" class="bgDescTablas"><label>
                      <input name="codtipofasecontrato" type="text" id="codtipofasecontrato" value="${codtipofasecontrato}" size="20" maxlength="6" onkeypress="javascript:return permite(event, 'num_car_cod')" tabindex="1"/>
                    </label>
                    </td>
                  </tr>
                  <tr>
...
<script>
    ...
    function validarPK()
    {
        llaves = 'codtipofasecontrato='+document.getElementById('codtipofasecontrato').value;
        //llaves+= 'codmunicipio='+document.getElementById('codmunicipio').value+',';
        validarLlave('tipofasecontrato',llaves);
    } 
    ...
    function buscar()
    {
        ...
        url = url + "tabla=tipofasecontrato&";
        url = url + "campos=codtipofasecontrato,descripcion,observacion&";
        url = url + "campoLlave=codtipofasecontrato";
