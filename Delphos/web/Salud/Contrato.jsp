...
<html>
    ...
    <body bgcolor="#FFFFFF" onLoad="borrarMensaje(combos[0]);">
        ...
        <div id="laTabla" style="display:none" title="Rips">
            Prueba
        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="sinBgDescTablas">
                                            ...
                                            <select name="codemprcontratista" id="codemprcontratista" style="width: 150px"
                                                    lang="CONSULTA->select codtipoidentidad, codempresa, nombre from empresa::
                                                    CAMPOS->codtipoidentidad codempresa::
                                                    MOSTRAR->nombre::
                                                    TITULO->ejemplo"
                                                    onclick="cargarTabla( this.lang )">
                                                <option id="codemprcontratista" value=""></option>
                                                <sql:query var="r" sql="select codtipoidentidad, codempresa, nombre from empresa LIMIT 100 OFFSET 0" dataSource="jdbc/delphos" scope="page"/>
                                                <jsp2:forEach items="${r.rows}" var="fila" varStatus="contador">
                                                    <c:choose>
                                        ...
                                        <!--
                                        <input type="text" name="codemprcontratista" id="codemprcontratista" value=""
                                               alt="CONSULTA->select codtipoidentidad, codempresa, nombre from empresa::
                                                CAMPOS-VALUE->codtipoidentidad codempresa::
                                                MOSTRAR->nombre" />
                                        -->
                                        <td>&nbsp;</td>
