...
<title>:: DELPHOS ::</title>
        ...
        <script type="text/javascript">
            ...
            var combos = new Array('coddiagnostico','coddiagnostico','codunidmedidaedadfin');
            
            //validar
            var arrayNonulos               	= new Array('edadinicial');
            var arrayNumerosEnteros        	= new Array('edadinicial','edadfinal');
            var arrayCombos               	= new Array('coddiagnostico','coddiagnostico','codunidmedidaedadfin');
...
<tr>
    ...
    <td valign="top">
                <center>
            <c:if test="${param.coddiagnostico != null && param.codunidmedidaedadini != null && param.edadinicial != null}">
            <sql:query var="r" sql="SELECT * FROM diagnosticoedad WHERE coddiagnostico='${param.coddiagnostico}' AND codunidmedidaedadini='${param.codunidmedidaedadini}' AND edadinicial='${param.edadinicial}'" dataSource="jdbc/delphos" scope="page"/>
            </c:if>
		...
		<form name="formulario" id="formulario" method="post" action="DiagnosticoEdad.jsp">
                  <span id="mensajeControlador">${msj}</span>
                  <tr>
                    <td colspan="6"><div align="center" class="titulo1">Diagn&oacute;stico Edad </div></td>
                  </tr>
                  <tr>
                    <td colspan="6">&nbsp;</td>
                  </tr>
                  <tr>
                    ...
                    <td width="104" class="bgDescTablas"><strong>Diagn&oacute;stico</strong></td>
                    <td colspan="4" class="bgDescTablas"><label>
                      <select name="coddiagnostico" id="coddiagnostico" style="width: 150px" tabindex="1">
                  ...
                  <tr>
                    ...
                    <td class="bgDescTablas"><input name="edadfinal" type="text" id="edadfinal" value="${edadfinal}" size="20" maxlength="4" onkeypress="javascript:return permite(event, 'nume')" tabindex="5"/></td>
                  </tr>
                  <tr>
                    <td colspan="6" class="bgDescTablas">&nbsp;</td>
                  </tr>
...
<script>
    ...
    function validarPK()
    {
        ...
        validarLlave('diagnosticoedad',llaves);
    } 
    ...
    function buscar()
    {
        ...
        url = url + "tabla=diagnosticoedad&";
        url = url + "campos=coddiagnostico,codunidmedidaedadini,edadinicial,codunidmedidaedadfin,edadfinal,observacion&";
        url = url + "campoLlave=coddiagnostico,codunidmedidaedadini,edadinicial";
