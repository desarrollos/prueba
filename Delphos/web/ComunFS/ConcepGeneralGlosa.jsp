...
<title>:: DELPHOS ::</title>
        ...
        <script type="text/javascript">
            ...
            var cajas = new Array('codconcepgeneralglosa','descripcion','aplicacion');
            var combos = null;
                       
            //validar          
            var arrayNonulos               	= new Array ('codconcepgeneralglosa');
            var arrayNumerosEnteros        	= null;
            var arrayCombos               	= null;
            var arrayCadenasANCod          	= new Array ('codconcepgeneralglosa');
...
<tr>
    ...
    <td valign="top">
            ...
            <sql:query var="r" sql="SELECT * FROM concepgeneralglosa WHERE codconcepgeneralglosa='${param.llave}'" dataSource="jdbc/delphos" scope="page"/>
            </c:if>
		...
		<form name="formulario" id="formulario" method="post" action="ConcepGeneralGlosa.jsp">
                  <span id="mensajeControlador">${msj}</span>
                  <tr>
                    <td colspan="6"><div align="center" class="titulo1">Concepto General Glosa</div></td>
                  </tr>
                  <tr>
                    <td colspan="6">&nbsp;</td>
                  </tr>
                  <tr>
                    ...
                    <td width="519" colspan="4" class="bgDescTablas"><label>
                      <input name="codconcepgeneralglosa" type="text" id="codconcepgeneralglosa" value="${codconcepgeneralglosa}" size="20" maxlength="6"onkeypress="javascript:return permite(event, 'num_car_cod')" tabindex="1"/>
                    </label></td>
                  </tr>
                  <tr>
...
<script>
    ...
    function validarPK()
    {
        ...
        validarLlave('concepgeneralglosa',llaves);
    } 
    ...
    function buscar()
    {
        ...
        url = url + "tabla=concepgeneralglosa&";
        url = url + "campos=codconcepgeneralglosa,descripcion,aplicacion&";
