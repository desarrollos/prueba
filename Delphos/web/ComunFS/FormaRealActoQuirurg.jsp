...
<title>:: DELPHOS ::</title>
        ...
        <script type="text/javascript">
            ...
            var cajas = new Array('codformarealactqui','descripcion','observacion');
            var combos = null;
			
            var arrayNonulos               	= new Array ('codformarealactqui');
            var arrayNumerosEnteros        	= null;
            var arrayCombos               	= null;			
            var arrayCadenasANCod          	= new Array ('codformarealactqui');
...
<tr>
    ...
    <td valign="top">
            ...
            <sql:query var="r" sql="SELECT * FROM formarealactoquirurg WHERE codformarealactqui='${param.llave}'" dataSource="jdbc/delphos" scope="page"/>
            </c:if>
            <jsp2:forEach items="${r.rows}" var="fila" varStatus="contador">
              <c:set var="codformarealactqui" value="${fila.codformarealactqui}"/> 
              <c:set var="descripcion" value="${fila.descripcion}"/>   
              <c:set var="observacion" value="${fila.observacion}"/> 
            </jsp2:forEach>
                
                <table width="853" border="0" class="tablaContenido">
		<form name="formulario" id="formulario" method="post" action="FormaRealActoQuirurg.jsp">
                  <span id="mensajeControlador">${msj}</span>
                  <tr>
                    <td colspan="3"><div align="center" class="titulo1">Forma Realizaci&oacute;n Acto Quirurgico</div></td>
                  </tr>
                  <tr>
                    <td colspan="3">&nbsp;</td>
                  </tr>
                  <tr>
                    ...
                    <td width="150" class="bgDescTablas"><strong>C&oacute;digo Forma Realizaci&oacute;n</strong></td>
                    <td width="459" class="bgDescTablas"><input name="codformarealactqui" type="text" id="codformarealactqui" value="${codformarealactqui}" size="20" maxlength="6" onkeypress="javascript:return permite(event, 'num_car_cod')" tabindex="1"/> </td>
              </tr>
                  <tr>
...
<script>
    ...
    function validarPK()
    {
        llaves = 'codformarealactqui='+document.getElementById('codformarealactqui').value;
        //llaves+= 'codmunicipio='+document.getElementById('codmunicipio').value+',';
        validarLlave('formarealactoquirurg',llaves);
    } 
    ...
    function buscar()
    {
        ...
        url = url + "tabla=formarealactoquirurg&";
        url = url + "campos=codformarealactqui,descripcion,observacion&";
        url = url + "campoLlave=codformarealactqui";
