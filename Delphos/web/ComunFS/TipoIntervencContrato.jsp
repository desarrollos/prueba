...
<title>:: DELPHOS ::</title>
        ...
        <script type="text/javascript">
            ...
            var cajas = new Array('codtipointervcontrato','descripcion','observacion');
            var combos = null;
            
            //validar
            var arrayNonulos               	= new Array ('codtipointervcontrato');
            var arrayNumerosEnteros        	= null;
            var arrayCombos               	= null;
            var arrayCadenasANCod          	= new Array ('codtipointervcontrato');
...
<tr>
    ...
    <td valign="top">
            ...
            <sql:query var="r" sql="SELECT * FROM tipointervenccontrato WHERE codtipointervcontrato='${param.llave}'" dataSource="jdbc/delphos" scope="page"/>
            </c:if>
		...
		<form name="formulario" id="formulario" method="post" action="TipoIntervencContrato.jsp">
                  <span id="mensajeControlador">${msj}</span>
                  <tr>
                    <td colspan="6"><div align="center" class="titulo1">Tipo Intervenci&oacute;n Contrato</div></td>
                  </tr>
                  <tr>
                    <td colspan="6">&nbsp;</td>
                  </tr>
                  <tr>
                    ...
                    <td width="137" class="bgDescTablas"><strong>C&oacute;digo Intervenci&oacute;n Contrato</strong></td>
                    <td width="471" colspan="4" class="bgDescTablas"><label>
                      <input name="codtipointervcontrato" type="text" id="codtipointervcontrato" value="${codtipointervcontrato}" size="20" maxlength="6" onkeypress="javascript:return permite(event, 'num_car_cod')" tabindex="1"/>
                    </label>
                    </td>
                  </tr>
                  <tr>
...
<script>
    ...
    function validarPK()
    {
        llaves = 'codtipointervcontrato='+document.getElementById('codtipointervcontrato').value;
        //llaves+= 'codmunicipio='+document.getElementById('codmunicipio').value+',';
        validarLlave('tipointervenccontrato',llaves);
    } 
    ...
    function buscar()
    {
        ...
        url = url + "tabla=tipointervenccontrato&";
        url = url + "campos=codtipointervcontrato,descripcion,observacion&";
        url = url + "campoLlave=codtipointervcontrato";
