...
<title>:: DELPHOS ::</title>
        ...
        <script type="text/javascript">
            ...
            var cajas = new Array('codestadoregistro','descripcion');
            var combos = null;
                        
            //validar
            var arrayNonulos               	= new Array ('codestadoregistro');
            var arrayNumerosEnteros        	= null;
            var arrayCombos               	= null;
            var arrayCadenasANCod          	= new Array ('codestadoregistro');
...
<tr>
    ...
    <td valign="top">
            ...
            <sql:query var="r" sql="SELECT * FROM estadoregistro WHERE codestadoregistro='${param.llave}'" dataSource="jdbc/delphos" scope="page"/>
            </c:if>
		...
		<form name="formulario" id="formulario" method="post" action="EstadoRegistro.jsp">
                  <span id="mensajeControlador">${msj}</span>
                  <tr>
                    <td colspan="6"><div align="center" class="titulo1">Estado Registro</div></td>
                  </tr>
                  <tr>
                    <td colspan="6">&nbsp;</td>
                  </tr>
                  <tr>
                    ...
                    <td width="127" class="bgDescTablas"><strong>C&oacute;digo Estado Registro</strong></td>
                    <td width="519" colspan="4" class="bgDescTablas"><label>
                      <input name="codestadoregistro" type="text" id="codestadoregistro" value="${codestadoregistro}" size="20" maxlength="6" onkeypress="javascript:return permite(event, 'num_car_cod')" tabindex="1"/>
                    </label></td>
                  </tr>
                  <tr>
...
<script>
    ...
    function validarPK()
    {
        llaves = 'codestadoregistro='+document.getElementById('codestadoregistro').value;
        //llaves+= 'codmunicipio='+document.getElementById('codmunicipio').value+',';
        validarLlave('estadoregistro',llaves);
    } 
    ...
    function buscar()
    {
        ...
        url = url + "tabla=estadoregistro&";
        url = url + "campos=codestadoregistro,descripcion&";
        url = url + "campoLlave=codestadoregistro";
