...
<title>:: DELPHOS ::</title>
        ...
        <script type="text/javascript">
            ...
            var combos = new Array('codtareas','codsuministros');
            
            //validar
            var arrayNonulos               	= null;
            var arrayNumerosEnteros        	= null;
            var arrayCombos               	= new Array('codtareas','codsuministros');
...
<tr>
    ...
    <td valign="top">
                <center>
            <c:if test="${param.codtarea != null && param.codsuministro != null}">
            <sql:query var="r" sql="SELECT * FROM tareasuministro WHERE codtarea='${param.codtarea}' AND codsuministro='${param.codsuministro}'" dataSource="jdbc/delphos" scope="page"/>
            </c:if>
            <jsp2:forEach items="${r.rows}" var="fila" varStatus="contador">
              ...
              <c:set var="observacion" value="${fila.observacion}"/>   
                ...
                <table width="733" border="0" class="tablaContenido">
		<form action="TareaSuministro.jsp" method="post" name="formulario" id="formulario">
                  <span id="mensajeControlador">${msj}</span>
                  <tr>
                    <td colspan="6"><div align="center" class="titulo1">Tarea Suministros</div></td>
                  </tr>
                  <tr>
                    <td colspan="6">&nbsp;</td>
                  </tr>
                  <tr>
                    ...
                    <td width="75" class="bgDescTablas"><strong>Tarea</strong>
                    <label></label></td>
                    <td width="231" class="bgDescTablas">
                    ...
                    <td width="8" class="bgDescTablas">&nbsp;</td>
                    <td width="98" class="bgDescTablas"><strong><strong><strong>Suministro</strong></strong></strong></td>
                    <td width="202" class="bgDescTablas"><label>
...
<script>
    ...
    function validarPK()
    {
        ...
        validarLlave('tareasuministro',llaves);
    } 
    ...
    function buscar()
    {
        ...
        url = url + "tabla=tareasuministro&";
        url = url + "campos=codtarea,codsuministro,observacion&";
        url = url + "campoLlave=codtarea,codsuministro";
