...
<title>:: DELPHOS ::</title>
        ...
        <script type="text/javascript">
            ...
            var cajas = new Array('codgruposumin','codalterno','descripcion','observacion');
            var combos = null;
			
            var arrayNonulos               	= new Array('codgruposumin');
            var arrayNumerosEnteros        	= null;
            var arrayCombos               	= null;			
            var arrayCadenasANCod          	= new Array('codgruposumin','codalterno');
...
<tr>
    ...
    <td valign="top">
            ...
            <sql:query var="r" sql="SELECT * FROM gruposuministro WHERE codgruposumin='${param.llave}'" dataSource="jdbc/delphos" scope="page"/>
            </c:if>
		...
		<form name="formulario" id="formulario" method="post" action="GrupoSuministro.jsp">
                  <span id="mensajeControlador">${msj}</span>
                  <tr>
                    <td colspan="9"><div align="center" class="titulo1">Grupo Suministro</div></td>
                  </tr>
                  <tr>
                    <td colspan="9">&nbsp;</td>
                  </tr>
                  <tr>
                    ...
                    <td width="140" class="bgDescTablas"><strong>C&oacute;digo Grupo Suministro</strong></td>
                    <td width="163" class="bgDescTablas"><input name="codgruposumin" type="text" id="codgruposumin" value="${codgruposumin}" size="20" maxlength="6" onkeypress="javascript:return permite(event, 'num_car_cod')" tabindex="1"/></td>
...
<script>
    ...
    function validarPK()
    {
        llaves = 'codgruposumin='+document.getElementById('codgruposumin').value;
        //llaves+= 'codmunicipio='+document.getElementById('codmunicipio').value+',';
        validarLlave('gruposuministro',llaves);
    } 
    ...
    function buscar()
    {
        ...
        url = url + "tabla=gruposuministro&";
        url = url + "campos=codgruposumin,codalterno,descripcion,observacion&";
        url = url + "campoLlave=codgruposumin";
