...
<title>:: DELPHOS ::</title>
        ...
        <script type="text/javascript">
            ...
            var cajas = new Array('codtipoparentesco','descripcion');
            var combos = null;
            
            //validar
            var arrayNonulos               	= new Array ('codtipoparentesco');
            var arrayNumerosEnteros        	= null;
            var arrayCombos               	= null;
            var arrayCadenasANCod          	= new Array ('codtipoparentesco');
...
<tr>
    ...
    <td valign="top">
            ...
            <sql:query var="r" sql="SELECT * FROM tipoparentesco WHERE codtipoparentesco='${param.llave}'" dataSource="jdbc/delphos" scope="page"/>
            </c:if>
		...
		<form name="formulario" id="formulario" method="post" action="TipoParentesco.jsp">
                  <span id="mensajeControlador">${msj}</span>
                  <tr>
                    <td colspan="6"><div align="center" class="titulo1">Tipo Parentesco</div></td>
                  </tr>
                  <tr>
                    <td colspan="6">&nbsp;</td>
                  </tr>
                  <tr>
                    ...
                    <td width="127" class="bgDescTablas"><strong>C&oacute;digo Tipo Parentesco</strong></td>
                    <td width="519" colspan="4" class="bgDescTablas"><label>
                      <input name="codtipoparentesco" type="text" id="codtipoparentesco" value="${codtipoparentesco}" size="20" maxlength="6" onkeypress="javascript:return permite(event, 'num_car_cod')" tabindex="1"/>
                    </label></td>
                  </tr>
                  <tr>
...
<script>
    ...
    function validarPK()
    {
        llaves = 'codtipoparentesco='+document.getElementById('codtipoparentesco').value;
        //llaves+= 'codmunicipio='+document.getElementById('codmunicipio').value+',';
        validarLlave('tipoparentesco',llaves);
    } 
    ...
    function buscar()
    {
        ...
        url = url + "tabla=tipoparentesco&";
        url = url + "campos=codtipoparentesco,descripcion&";
        url = url + "campoLlave=codtipoparentesco";
