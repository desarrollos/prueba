...
<title>:: DELPHOS ::</title>
        ...
        <script type="text/javascript">
            ...
            var cajas = new Array('codespecialidad','descripcion','observacion');
            var combos = null;
			
            var arrayNonulos               	= new Array ('codespecialidad');
            var arrayNumerosEnteros        	= null;
            var arrayCombos               	= null;		
            var arrayCadenasANCod          	= new Array ('codespecialidad');
...
<tr>
    ...
    <td valign="top">
            ...
            <sql:query var="r" sql="SELECT * FROM especialidad WHERE codespecialidad='${param.llave}'" dataSource="jdbc/delphos" scope="page"/>
            </c:if>
		...
		<form name="formulario" id="formulario" method="post" action="Especialidad.jsp">
                  <span id="mensajeControlador">${msj}</span>
                  <tr>
                    <td colspan="6"><div align="center" class="titulo1">Especialidad o Profesi&oacute;n</div></td>
                  </tr>
                  <tr>
                    <td colspan="6">&nbsp;</td>
                  </tr>
                  <tr>
                    ...
                    <td width="139" class="bgDescTablas"><strong>C&oacute;digo Especialidad</strong></td>
                    <td width="519" colspan="4" class="bgDescTablas"><label>
                      <input name="codespecialidad" type="text" id="codespecialidad" value="${codespecialidad}" size="20" maxlength="6" onkeypress="javascript:return permite(event, 'num_car_cod')" tabindex="1"/>
                    </label></td>
                  </tr>
                  <tr>
...
<script>
    ...
    function validarPK()
    {
        llaves = 'codespecialidad='+document.getElementById('codespecialidad').value;
        //llaves+= 'codmunicipio='+document.getElementById('codmunicipio').value+',';
        validarLlave('especialidad',llaves);
    } 
    ...
    function buscar()
    {
        ...
        url = url + "tabla=especialidad&";
        url = url + "campos=codespecialidad,descripcion,observacion&";
        url = url + "campoLlave=codespecialidad";
