...
<title>:: DELPHOS ::</title>
        ...
        <script type="text/javascript">
            ...
            var cajas = new Array('codestadosala','descripcion');
            var combos = null;
			
			var arrayNonulos               	= new Array ('codestadosala');
			var arrayNumerosEnteros        	= null;
			var arrayCombos               	= null;			
			var arrayCadenasANCod          	= new Array ('codestadosala');
...
<tr>
    ...
    <td valign="top">
            ...
            <sql:query var="r" sql="SELECT * FROM estadosala WHERE codestadosala='${param.llave}'" dataSource="jdbc/delphos" scope="page"/>
            </c:if>
		...
		<form name="formulario" id="formulario" method="post" action="EstadoSala.jsp">
                  <span id="mensajeControlador">${msj}</span>
                  <tr>
                    <td colspan="6"><div align="center" class="titulo1">Estado Sala</div></td>
                  </tr>
                  <tr>
                    <td colspan="6">&nbsp;</td>
                  </tr>
                  <tr>
                    ...
                    <td width="153" class="bgDescTablas"><strong>C&oacute;digo Estado Sala</strong></td>
                    <td width="456" colspan="4" class="bgDescTablas"><label>
                      <input name="codestadosala" type="text" id="codestadosala" value="${codestadosala}" size="20" maxlength="6" onkeypress="javascript:return permite(event, 'num_car_cod')" tabindex="1"/>
                    </label></td>
                  </tr>
                  <tr>
...
<script>
    ...
    function validarPK()
    {
        llaves = 'codestadosala='+document.getElementById('codestadosala').value;
        //llaves+= 'codmunicipio='+document.getElementById('codmunicipio').value+',';
        validarLlave('estadosala',llaves);
    } 
    ...
    function buscar()
    {
        ...
        url = url + "tabla=estadosala&";
        url = url + "campos=codestadosala,descripcion&";
        url = url + "campoLlave=codestadosala";
