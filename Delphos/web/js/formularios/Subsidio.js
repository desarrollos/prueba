	...
	$("#ajax").ajaxStop( function() {
		 ...
		 if( op == 'registrar_subsidio' ) {
		  ...
		  if( op == 'actualizar_subsidio' ) {
			 if( es == 'si' && er == 'no' ) bottomMensaje('Subsidio se actualizo correctamente','Estado actualizacion', 'ex', 's');			 if( es == 'no' && er == 'si' ) bottomMensaje('Subsidio no registro correctamente: <br /><br /><span class="error"> '				  + ed + "</span>", 'Error al actualizar el registro', 'e', 'n'); 
		 } 
