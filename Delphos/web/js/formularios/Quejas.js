$(document).ready( function( ) {
    ...
    $("#ajax").ajaxStop( function() {
        ...
        if( op == 'actualizar_quejas' ) {
            if( es == 'si' && er == 'no' ) bottomMensaje('La queja se actualizo correctamente','Estado actualizacion', 'ex', 's');
            if( es == 'no' && er == 'si' ) bottomMensaje('La queja no registro correctamente: <br /><br /><span class="error"> '				  + ed + "</span>", 'Error al actualizar el registro', 'e', 'n'); 
        } 
        ...
        if( op == 'actualizar_quejadocumento' ) {
            ...
            if( es == 'no' && er == 'si' ) bottomMensaje('El documento no registro correctamente: <br /><br /><span class="error"> '				  + ed + "</span>", 'Error al actualizar el registro', 'e', 'n'); 
        } 
        ...
        if( op == 'actualizar_quejarespuesta' ) {
            ...
            if( es == 'no' && er == 'si' ) bottomMensaje('La respuesta no registro correctamente: <br /><br /><span class="error"> '				  + ed + "</span>", 'Error al actualizar el registro', 'e', 'n'); 
        } 
